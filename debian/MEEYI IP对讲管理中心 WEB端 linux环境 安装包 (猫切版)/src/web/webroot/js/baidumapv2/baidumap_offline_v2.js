...
(function() {
    ...
    x.D.$ = function(a) {
        return "string" == typeof a || a instanceof String
            ...
            : a && a.nodeName && (1 == a.nodeType || 9 == a.nodeType) ? a : p;
    };
    x.$ = x.Ec = x.D.$;
    x.D.U = function(a) {
        a = x.D.$(a);
    ...
    x.Sk.Ro = function(a, b) {
        ...
        if (c.length) {
            c =
                c.length == 1
                    ? b !== p &&
                      /\[object Array\]|\[object Object\]/.test(d.call(b))
                      ? b
                      : c
                    : c;
    ...
    x.D.tj = function(a, b) {
        ...
        if (!d) {
            var e = c.DB[b],
                d =
                    a.currentStyle ||
                    (x.ea.la ? a.style : getComputedStyle(a, p)),
        ...
        a.prototype = {
            ...
            move: function(a) {
                ...
                if (
                    10 <
                        Math.abs(
                            (this.zk ? a.touches[0].clientX : a.clientX) -
                                this.au
                        ) ||
    ...
    x.extend(Ka.prototype, {
        ...
        ik: function(a, b, c, d) {
            ...
            if ((c = c && d ? f.Jm(c, this.Vb) : this.lc)) {
                if (
                    ((this.lc = new H(c.lng + a * e, c.lat - b * e)),
        ...
        lw: function(a) {
            a &&
                Wa(a.Ce) &&
                (a.Ce(this), this.dispatchEvent(new N("onaddcontrol", a)));
        },
        vN: function(a) {
            a &&
                Wa(a.remove) &&
        ...
        uo: function(a) {
            a &&
                Wa(a.qa) &&
                (a.qa(this), this.dispatchEvent(new N("onaddcontextmenu", a)));
        },
        zp: function(a) {
            a &&
                Wa(a.remove) &&
                (this.dispatchEvent(new N("onremovecontextmenu", a)),
                a.remove());
        },
        Ia: function(a) {
            a &&
                Wa(a.Ce) &&
                (a.Ce(this), this.dispatchEvent(new N("onaddoverlay", a)));
        },
        Sb: function(a) {
            a &&
                Wa(a.remove) &&
                ...
                if (Za(a)) {
                    if (b.Hb === Oa) {
                        ...
                        d.wF(function(c) {
                            0 === d.um() &&
                                2 === d.Ea.result.type &&
                                (b.Vf(c.xk(0).point), Oa.tk(a) && b.qF(a));
                        });
            ...
            if (Za(a)) {
                if (c.Hb === Oa) {
                    ...
                    e.wF(function(d) {
                        if (
                            0 === e.um() &&
                            (2 === e.Ea.result.type || 11 === e.Ea.result.type)
                        ) {
                            var d = d.xk(0).point,
                ...
                if (a instanceof H && b) {
                    ...
                    f.zoom = b;
                    c.loaded ||
                        ((c.loaded = o), c.dispatchEvent(f), sa || (sa = ab()));
                    c.dispatchEvent(g);
                    f = new N("onmoveend");
                    f.iH = "centerAndZoom";
        ...
        MR: function(a, b) {
            for (
                ...
                var k = this.oa().Bc(i);
                if (
                    a.KF().lng / k < this.width - f &&
                    a.KF().lat / k < this.height - d
                ) {
                    break;
                }
            }
        ...
        Zs: function(a, b) {
            ...
            if (
                ...
                (a instanceof fb && a.yj())
            ) {
                return c;
            }
            var d = [];
            a instanceof fb
                ? (d.push(a.kf()), d.push(a.re()))
                : (d = a.slice(0));
        ...
        Nt: function(a) {
            ...
            if (a) {
                ...
                a.style &&
                    (c = b.K.dm[a.style]
                        ? b.K.dm[a.style].backColor
                        : b.K.dm.normal.backColor) &&
        ...
        var l = {
            send: function(a) {
                ...
                0 < f.length &&
                    ...
                    (f = new Image()),
                    (f.src =
                        "http://static.tieba.baidu.com/tb/pms/img/st.gif?" +
                        e.join("&")),
            ...
            (function(a, b, c) {
                ...
                function u() {
                    ...
                    if (this.tK || /^(on|un|set|get|create)$/.test(b)) {
                        for (
                            var b = w.prototype[b], c = [], d = 1, e = a.length;
                            d < e;
                            d++
                        ) {
                            c.push(a[d]);
                ...
                if (!C || !C.Ho) {
                    ...
                    A &&
                        k(b, "mouseup", function(a) {
                            ...
                            1 == a.nodeType &&
                                /^ajavascript:/i.test(a.tagName + a.href);
                        });
                    var Ya = q;
                    a.onerror = function(a, b, d, e) {
                        var g = o;
                        !b &&
                            /^script error/i.test(a) &&
                            (Ya ? (g = q) : (Ya = o));
                        g &&
    ...
    x.extend(Sb.prototype, {
        ...
        Ce: function(a) {
            !this.B &&
                (this.initialize && Wa(this.initialize)) &&
    ...
    x.object.extend(cc.prototype, {
        ...
        removeItem: function(a) {
            if (a && "menuitem" == a.Lb) {
                for (var b = 0, c = this.xa.length; b < c; b++) {
                    this.xa[b] === a &&
                        (this.xa[b].remove(), this.xa.splice(b, 1), c--);
                }
                b = 0;
                for (c = this.Ff.length; b < c; b++) {
                    this.Ff[b] === a &&
                        (this.Ff[b].remove(), this.Ff.splice(b, 1), c--);
                }
            }
        },
        RB: function() {
    ...
    x.object.extend(fb.prototype, {
        ...
        mb: function(a) {
            return !(a instanceof fb) || this.yj()
                ? q
                : this.re().mb(a.re()) && this.kf().mb(a.kf());
        },
        re: t("Ll"),
        kf: t("ul"),
        GV: function(a) {
        ...
        Ja: function() {
            return this.yj()
                ? p
                : new H((this.Je + this.Ee) / 2, (this.Ie + this.De) / 2);
        },
        ft: function(a) {
            if (
                !(a instanceof fb) ||
        ...
        KF: function() {
            return this.yj()
                ? new H(0, 0)
                : new H(
                      Math.abs(this.Ee - this.Je),
                      Math.abs(this.De - this.Ie)
                  );
        }
    });
    function H(a, b) {
    ...
    H.bM = function(a) {
        return (
            a && 180 >= a.lng && -180 <= a.lng && 74 >= a.lat && -74 <= a.lat
        );
    };
    ...
    x.extend(mc.prototype, {
        Hj: function() {
            ...
            "none" != a.borderColor &&
                c.push("border:" + a.Px + "px " + a.zY + " " + a.qM + ";");
            c.push(
                "opacity:" +
                    a.opacity +
                    "; filter:(opacity=" +
    ...
    function pc(a, b, c, d) {
        a &&
            ...
            (this.$j = isNaN(parseFloat(b))
                ? 1
                : this.EI ? parseFloat(b) / 100 : parseFloat(b)),
            (this.FI = !!(c.indexOf("%") + 1)),
            (this.repeat =
                c != j ? (this.FI ? parseFloat(c) / 100 : parseFloat(c)) : 0));
    }
    function qc(a, b) {
        x.lang.Ba.call(this);
        this.content = a;
        ...
        if (
            0 != this.z.maxWidth &&
            (220 > this.z.maxWidth && (this.z.maxWidth = 220),
            730 < this.z.maxWidth)
        ) {
            this.z.maxWidth = 730;
        }
    ...
    x.extend(wc.prototype, {
        initialize: function(a) {
            this.gB &&
                this.gB.push({ method: "initialize", arguments: arguments });
        },
        setPoints: function(a) {
            this.ke &&
                this.ke.push({ method: "setPoints", arguments: arguments });
        },
        setStyles: function(a) {
            this.ke &&
                this.ke.push({ method: "setStyles", arguments: arguments });
        },
        clear: function() {
    ...
    x.extend(Bc.prototype, {
        ...
        ev: function(a, b) {
            ...
            for (
                ...
                var i = Math.PI / 180 * g,
                    k = Math.asin(
                        Math.sin(e) * Math.cos(d) +
                            Math.cos(e) * Math.sin(d) * Math.cos(i)
                    ),
                    i = new H(
                        ((f -
                            Math.atan2(
    ...
    x.extend(Dc.prototype, {
        ...
        vf: function() {
            ...
            var a = this;
            this.pE &&
                (this.map.dispatchEvent(new N("onfirsttileloaded")),
                (this.pE = q));
            0 == this.th &&
                ...
                (function(a) {
                    return function(b, c) {
                        return (
                            ...
                            (0.4 * Math.abs(c[0] - a[0]) +
                                0.6 * Math.abs(c[1] - a[1]))
                        );
                    };
                })([v[0] - 1, v[1] - 1])
            );
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (i.vw) {
                    ...
                    if (a) {
                        ...
                        if (l && l.childNodes) {
                            for (
                                var m = l.childNodes.length, n = m - 1;
                                0 <= n;
                                n--
                            ) {
                                (m = l.childNodes[n]),
                ...
                if (
                    !i.ZH &&
                    !((i.mp && !this.map.Ub()) || (i.iM && this.map.Ub()))
                ) {
                    d = this.map;
                    e = d.oa();
                    k = e.bp();
        ...
        Nt: function(a) {
            ...
            if (
                !this.map.Ub() &&
                (a ? (this.map.K.s_ = a) : (a = this.map.K.s_), a)
            ) {
                for (
                    var c = p,
                        c =
                    ...
                    if (e.f_ == o) {
                        ...
                        e.getTilesUrl = function(b, d) {
                            ...
                            l = a.styleStr
                                ? l +
                                  ("&styles=" + encodeURIComponent(a.styleStr))
                                : l + ("&customid=" + a.style);
    ...
    function Lc(a, b) {
        ...
        this.k = {
            ...
            Bk:
                b.hotspotName ||
                "vector_md_" + (100000 * Math.random()).toFixed(0),
            SU: "LBS\u4e91\u9ebb\u70b9\u5c42"
        };
        this.mp = o;
        Ec.call(this, this.k);
    ...
    function Nc(a) {
        ...
        if (this.k.predictDate) {
            if (
                1 > this.k.predictDate.weekday ||
                7 < this.k.predictDate.weekday
            ) {
    ...
    Nc.prototype.getTilesUrl = function(a, b) {
        ...
        this.k.predictDate
            ...
            : ((c = "TrafficTileService?time=" + new Date().getTime() + "&"),
              (c += "label=web2D&v=016&"));
        return (this.wU + c + "level=" + b + "&x=" + a.x + "&y=" + a.y).replace(
            /-(\d+)/gi,
            "M$1"
        );
    };
    ...
    function nb(a, b) {
        ...
        c.oc = {
            ...
            Bk:
                b.hotspotName ||
                "tile_md_" + (100000 * Math.random()).toFixed(0),
            PF: o
        };
    ...
    nb.prototype.getTilesUrl = function(a, b) {
        var c = a.x,
            ...
            c =
                ...
                e.A_;
        e.PF ||
            ((e = (100000 * Math.random()).toFixed(0)),
            (c += "&timeStamp=" + e));
        this.xf
            ? (c += "&geotable_id=" + this.xf)
            : this.Pn && (c += "&databox_id=" + this.Pn);
        return c;
    };
        ...
        QV: function() {
            ...
            for (e = d; e <= b; e++) {
                0 < e &&
                    (e == this.page
                        ? a.push(
                              '<span style="margin-right:3px">' + e + "</span>"
                          )
                        : 1 <= e &&
                          e <= this.Id &&
                          ((d =
    ...
    x.extend(rd.prototype, {
        ...
        Kp: function(a) {
            ...
            this.k.Fk =
                "number" !== typeof a
                    ? rd.Cn
                    : 1 <= a && a <= rd.Cn ? Math.round(a) : rd.Cn;
        },
    ...
    function Na(a, b) {
        ...
        this.k.KS !== o &&
            (this.$n(), z.Ij("cus.fire", "count", "z_loadpanoramacount"));
        this.BT(this.B);
        ...
        uB: function() {
            if (this.C) {
                for (var a = this.C.tx(), b = 0; b < a.length; b++) {
                    (a[b] instanceof T || a[b] instanceof rc) &&
                        a[b].point &&
                        this.va.push(a[b]);
                }
            }
            ...
            for (var b in a) {
                ...
                switch (b) {
                    ...
                    case "navigationControl":
                        this.dispatchEvent(
                            new N("onnavigation_visible_changed")
                        );
                        break;
                    case "indoorSceneSwitchControl":
                        this.dispatchEvent(
                            new N("onindoor_default_switch_mode_changed")
                        );
                        break;
                    case "albumsControl":
                    ...
                    case "copyrightControlOptions":
                        this.dispatchEvent(
                            new N("oncopyright_options_changed")
                        );
                        break;
                    case "closeControl":
                    ...
                    case "indoorExitControl":
                        this.dispatchEvent(
                            new N("onindoorexit_options_changed")
                        );
                        break;
                    case "indoorFloorControl":
                        this.dispatchEvent(
                            new N("onindoorfloor_options_changed")
                        );
                }
            }
        },
            ...
            if (a && c) {
                if (a.mb(c)) {
                    ...
                    var a = b,
                        ...
                        d = this.Un();
                    a.pitch =
                        Math.round(180 * (Math.atan(c / d) / Math.PI)) || 0;
                }
            }
            return b;
        },
                    ...
                    if (a.id != b.Uv) {
                        ...
                        if (b.pl) {
                            ...
                            b.eH =
                                6371000 *
                                2 *
                                Math.atan2(Math.sqrt(c), Math.sqrt(1 - c));
                        }
                        c = new N("ondataload");
                        c.data = a;
                        b.dispatchEvent(c);
    ...
    x.extend(Wd, {
        iW: function(a, b, c) {
            ...
            b = { data: b };
            "position_changed" == a &&
                (b.data = Wd.Sd.wi(new Q(b.data.mercatorX, b.data.mercatorY)));
        ...
        this.options.zx &&
            (Event.prototype.stopImmediatePropagation ||
                ((document.body.removeEventListener = function(a, b, c) {
                    ...
                    a === "click"
                        ? d.call(document.body, a, b.NL || b, c)
    ...
    Fe.prototype = {
                ...
                ? (this[a + "ScrollbarWrapper"] ||
                  ...
                  "h" == a
                      ? ((this.KL = this.LL.clientWidth),
                        (this.SX = $d.max(
                            $d.round(this.KL * this.KL / this.vy),
                            8
                        )),
                        (this.RX.style.width = this.SX + "px"))
                      : ((this.JO = this.KO.clientHeight),
                        (this.Z_ = $d.max(
                            $d.round(this.JO * this.JO / this.Fp),
                            8
                        )),
                ...
                if (
                    ...
                    (this.options.Uk
                        ? ((c = getComputedStyle(this.Nb, p)
                          ...
                          (d = +(c[12] || c[4])),
                          (c = +(c[13] || c[5])))
                        : ((d = +getComputedStyle(this.Nb, p).left.replace(
                              /[^0-9-]/g,
                              ""
                          )),
                          (c = +getComputedStyle(this.Nb, p).top.replace(
                              /[^0-9-]/g,
                              ""
                          ))),
                    d != this.x || c != this.y)
        ...
        ZS: function(a) {
            ...
            if (this.options.zoom && te && 1 < a.touches.length) {
                (e = $d.abs(a.touches[0].pageX - a.touches[1].pageX)),
                    ...
                    b < this.options.Vk
                        ? (b =
                              0.5 *
                              this.options.Vk *
                              Math.pow(2, b / this.options.Vk))
                        : b > this.options.Xp &&
                          (b =
                              2 *
                              this.options.Xp *
                              Math.pow(0.5, this.options.Xp / b)),
                ...
                if (0 < e || e < this.ee) {
                    e = this.options.Bo
                        ? this.x + c / 2
                        : 0 <= e || 0 <= this.ee ? 0 : this.ee;
                }
                if (f > this.nf || f < this.od) {
                    f = this.options.Bo
                        ? this.y + d / 2
                        : f >= this.nf || 0 <= this.od ? this.nf : this.od;
                }
                this.NC += c;
                this.OC += d;
                        ...
                        f.Aa || g.Aa
                            ? ((c = $d.max($d.max(f.time, g.time), 10)),
                              b.options.Yt &&
                                  ((f = d - b.gw),
                                  (g = e - b.hw),
                                  $d.abs(f) < b.options.Fy &&
                                  $d.abs(g) < b.options.Fy
        ...
        io: function(a) {
            var b = 0 <= this.x ? 0 : this.x < this.ee ? this.ee : this.x,
                c =
                    this.y >= this.nf || 0 < this.od
                        ? this.nf
                        : this.y < this.od ? this.od : this.y;
            if (b == this.x && c == this.y) {
                if (
                    ...
                    this.mi &&
                        this.options.Dx &&
                        ("webkit" == be && (this.LL.style[pe] = "300ms"),
        ...
        EU: function(a) {
            ...
            if ("zoom" == b.options.SO) {
                if (
                    ((d =
                        b.scale *
                        Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0))),
        ...
        eJ: function(a, b) {
            ...
            a = this.Qe[e];
            d = (d = $d.abs(a - this.Qe[this.yC]))
                ? 500 * ($d.abs(this.x - a) / d)
                : 0;
            this.yC = e;
            e = this.pf.length - 1;
            for (c = 0; c < e; c++) {
            ...
            b = this.pf[e];
            c = (c = $d.abs(b - this.pf[this.zC]))
                ? 500 * ($d.abs(this.y - b) / c)
                : 0;
            this.zC = e;
        ...
        refresh: function() {
            ...
            this.vn =
                this.options.vn &&
                ((!this.options.iV && !this.hp) || this.Fp > this.yn);
            ...
            if ("string" == typeof this.options.Yt) {
                ...
                for (b = c.length; a < b; a++) {
                    (d = this.$j(c[a])),
                        ...
                        (d.top += this.UF),
                        (this.Qe[a] =
                            d.left < this.ee ? this.ee : d.left * this.scale),
                        (this.pf[a] =
                            d.top < this.od ? this.od : d.top * this.scale);
                }
            } else {
                if (this.options.Yt) {
    ...
    z.Sm(function(a) {
        ...
        a.addEventListener("position_changed", function() {
            a.k.visible &&
                ...
                (b
                    ? b.ny(a.Yb())
                    : ((b = new Ge(a.k.albumsControlOptions)), b.qa(a)));
        });
    ...
    x.extend(Ge.prototype, {
        ...
        ds: function() {
            ...
            var b = this.B.style;
            b.cssText =
                "background:rgb(37,37,37);background:rgba(37,37,37,0.9);";
            b.position = "absolute";
            b.zIndex = "2000";
            b.width =
                isNaN(Number(this.k.maxWidth)) === o
        ...
        ny: function(a, b) {
            if (
                ...
                !this.bk[this.Yc] ||
                !(
                    this.bk[this.Yc].panoId == a &&
                    3 !== this.bk[this.Yc].recoType
                )
            ) {
                var c = this,
                    d = this.BH(a);
                !b && -1 !== d && this.bk[d] && 3 !== this.bk[d].recoType
                    ...
                    : this.xX(function(a) {
                          ...
                          for (var u in b) {
                              k
                                  ? l.push({ data: u + "F", index: u })
                                  : l.push({ data: Je[u], index: u });
                          }
                          c.TG = b;
                          c.Pi = l;
                          c.Dl(a);
        ...
        OV: function() {
            if (this.Mi) {
                ...
                x.M(b, "click", function(a) {
                    if (
                        (a = (a.srcElement || a.target).getAttribute(
                            "dataindex"
                        ))
                    ) {
                        c.Dl(c.TG[a]);
                ...
                var a = K("div"),
                    ...
                    i = [
                        "background:url(" +
                            F.pa +
                            "panorama/catlog_icon.png) no-repeat;",
                ...
                a.style.cssText =
                    "position:absolute;top:0px;left:0px;width:60px;";
                d.appendChild(e);
                f.appendChild(g);
        ...
        PV: function() {
            if (this.Pi && !(0 >= this.Pi.length)) {
                ...
                this.Mi &&
                    (this.Mi.style.left =
                        parseInt(this.Mi.style.left, 10) +
                        this.eg.width +
                        8 +
                        "px");
                var b = this;
        ...
        XP: function() {
            ...
            x.M(this.gk, "click", function(b) {
                if (
                    (b = (b.srcElement || b.target).getAttribute(
                        "data-index"
                    )) &&
                    b != a.Yc
                ) {
        ...
        Jp: function(a) {
            ...
            this.fk.setAttribute(
                "data-index",
                this.pB[a].getAttribute("data-index")
            );
            this.Yc = a;
            this.kK(a);
        },
        ...
        scrollTo: function(a) {
            a =
                a < this.Ug.offsetLeft
                    ? Math.ceil((a - this.Gi - this.co) / this.Lr) * this.Lr +
                      this.co +
                      this.Gi -
                      8
