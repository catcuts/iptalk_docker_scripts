...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/mp3playlist.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
	...
	data: function data() {
		return {
			playlist: [],
			footerItems: [{ type: "checkbox", text: '全选', name: "selectAll", change: 'selectAll' }, { text: '播放模式', name: "playmode", width: '', children: [{ text: '单曲循环', name: "playmode", icon: 'repeat', active: true, group: 'a' }, { text: '随机播放', name: "playmode", icon: 'random', group: 'a' }, { text: '顺序播放', icon: 'sort alphabet ascending', name: "playmode", group: 'a' }] }, { text: "删除", icon: 'remove', right: true, click: "onMultiDel" }, { type: "search", right: true, change: "onSearchChange" }],
			mp3IdList: []
		};
	},
	...
	watch: {
		playlist: function playlist(nval, oval) {}
	},
	computed: {},
	methods: {
		mouseAction: function mouseAction(event) {
			$(".field").hover(function (event) {
				var ele = $(this).find('button');
				for (var item in ele) {
					if (ele[item].title === '删除') {
						$(ele[item]).css("visibility", "visible");
					}
					if (ele[item].title === '重命名') {
						$(ele[item]).css("visibility", "visible");
					}
				}
			}, function (event) {
				...
				for (var item in ele) {
					if (ele[item].title === '删除') {
						$(ele[item]).css("visibility", "hidden");
					}
					if (ele[item].title === '重命名') {
						$(ele[item]).css("visibility", "hidden");
					}
		...
		domUpdatedCallback: function domUpdatedCallback(event) {
			...
			$('.ui.mp3item.checkbox').checkbox({
				onChecked: function onChecked() {
					var mp3id = $(this).attr('id');
					var mp3Name = $(this).siblings('label').text();
					self.dispatch('addMp3ItemName', mp3Name);
					self.mp3IdList.push(mp3id);
				},
				onUnchecked: function onUnchecked() {
					var mp3id = $(this).attr('id');
					var mp3Name = $(this).siblings('label').text();
					self.dispatch('removeMp3ItemName', mp3Name);
					self.mp3IdList.splice($.inArray(mp3id, self.mp3IdList), 1);
				}
			});

			$('.mp3footer .item .ui.toggle.checkbox').checkbox({
				onChecked: function onChecked() {
					var $childCheckbox = $(this).parents('.mp3footer').siblings('.relaxed.list').find('.checkbox');
		...
		onStopBubbling: function onStopBubbling(event) {
			event.stopPropagation();
		},
		onRenameMp3: function onRenameMp3(mp3) {
			mp3.rename = !mp3.rename;
		},
		onDeleteMp3: function onDeleteMp3(mp3) {
			var self = this;
			confirm(L("确定要删除所选曲目？")).then(function (obj) {
				if (obj.button.classs == "positive") {
					self.playlist.splice($.inArray(mp3, self.playlist), 1);
					var _iteratorNormalCompletion = true;
					var _didIteratorError = false;
					var _iteratorError = undefined;

					try {
						for (var _iterator = self.mp3IdList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
							var item = _step.value;

							if (item === mp3.id) {
								self.mp3IdList.splice($.inArray(item, self.mp3IdList), 1);
								break;
							}
						}
					} catch (err) {
					...
					$(self.$el).find('.checked').checkbox('uncheck');
				}
			});
		},
		onConfirm: function onConfirm(mp3) {
			var newname = $('.getmp3name').val();
			mp3.name = newname;
			mp3.rename = !mp3.rename;
		},
		inputGetFocus: function inputGetFocus(event) {
			event.target.style.background = '#DCDDDE';
		},
		inputGetBlur: function inputGetBlur(event) {
			event.target.style.background = '#FFFFFF';
		}
	},
	created: function created() {
		var self = this;
		_webservice2.default.get(_hisurls.getplaylist).then(function (response) {
			if (response.status == 'success') {
				self.playlist = response.result;
			}
		});

		this.$on('onMultiDel', function () {
			if (self.mp3IdList.length === 0) {
				alert('请选择要删除的曲目');
			} else {
				confirm(L("确定要删除所选曲目？")).then(function (obj) {
					if (obj.button.classs == "positive") {
						self.mp3IdList.forEach(function (item) {
							var _iteratorNormalCompletion2 = true;
							var _didIteratorError2 = false;
							var _iteratorError2 = undefined;

							try {
								for (var _iterator2 = self.playlist[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
		...
		this.$on('onSearchChange', function (item) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f672a92\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/mp3playlist.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.mp3footer[data-v-4f672a92]{\r\n        position: absolute;\r\n        bottom: 0px;\r\n        left: 0px;\r\n        right: 0px;\r\n        /*overflow: hidden;设置成隐藏播放模式的弹出会被隐藏*/\n}\r\n\r\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-4f672a92\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/mp3playlist.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, _vm._l((_vm.playlist), function(mp3) {
    return _c('div', {
      staticClass: "item mp3items"
    }, [_c('div', {
      staticClass: "field",
      on: {
        "mouseover": _vm.mouseAction
      }
    }, [_c('div', {
      staticClass: "ui mp3item checkbox ",
      class: {
        checked: mp3.selected
      }
    }, [_c('input', {
      attrs: {
        "type": "checkbox",
    ...
    }), _vm._v(" "), (!mp3.rename) ? _c('label', [_vm._v(_vm._s(_vm.L(mp3.name)))]) : _vm._e()]), _vm._v(" "), (mp3.rename) ? _c('div', {
      staticClass: "ui mini icon input"
    }, [_c('input', {
      staticClass: "getmp3name",
      attrs: {
        "type": "text"
      },
      domProps: {
      ...
      on: {
        "focus": function($event) {
          _vm.inputGetFocus($event)
        },
        "blur": function($event) {
          _vm.inputGetBlur($event)
        }
      }
    }), _vm._v(" "), _c('i', {
      staticClass: "edit icon"
    })]) : _vm._e(), _vm._v(" "), _c('button', {
      staticClass: "ui mini basic blue button",
      staticStyle: {
        "float": "right",
    ...
    }, [_vm._v("\n\t\t\t\t\t\t\t重命名\n\t\t\t\t\t\t")]) : _vm._e(), _vm._v(" "), (mp3.rename) ? _c('button', {
      staticClass: "ui mini basic blue button",
      staticStyle: {
        "float": "right",
        "padding": "5px 10px 5px"
    ...
    staticClass: "mp3footer"
  }, [_c('menubar', {
    attrs: {
      "theme": _vm.theme,
      "icon": true,
      "items": _vm.footerItems
    }
  })], 1)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4f672a92", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f672a92\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/mp3playlist.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("6aea1b1e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f672a92\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./mp3playlist.async.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4f672a92\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./mp3playlist.async.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/apps/meeyihis/components/mp3playlist.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/mp3playlist.async.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-4f672a92\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/mp3playlist.async.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-4f672a92",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\apps\\meeyihis\\components\\mp3playlist.async.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] mp3playlist.async.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4f672a92", Component.options)
  } else {
    hotAPI.reload("data-v-4f672a92", Component.options)
  }
