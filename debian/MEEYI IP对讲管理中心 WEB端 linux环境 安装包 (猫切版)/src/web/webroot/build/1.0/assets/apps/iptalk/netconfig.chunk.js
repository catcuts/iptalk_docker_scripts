...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/netconfig.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            formMeta: {
                ...
                footer: {
                    default: false,
                    items: [{ name: "submit", text: L("提交", "iptalk"), classs: "primary submit", icon: "checkmark", tips: L("提交表单", "iptalk"), click: "submit" }, { name: "retweet", text: L("立即复位", "iptalk"), classs: "primary submit", icon: "retweet", tips: L("立即复位", "iptalk"), click: function click() {
                            this.$parent.$parent.onReset();
                        } }, { name: "restart", text: L("立即重启", "iptalk"), classs: "primary", icon: "refresh", tips: L("立即重启", "iptalk"), click: function click() {
                            this.$parent.$parent.onRestart();
                        } }]
                },
                fields: []
            },
    ...
    methods: {
        onReset: function onReset() {
            this.extraDatas.cmd = 'resetNetwork';
        },
        onRestart: function onRestart() {
            this.showTip = true;
            this.showTipText = L("已重启，请稍后刷新", "iptalk");
            var self = this;
            setTimeout(function () {
                self.showTip = false;
            }, 3000);
            _axios2.default.get(urls.sysRestart);
        },
        onBeforeSubmit: function onBeforeSubmit() {
            if (this.extraDatas.cmd != 'resetNetwork') {
                this.extraDatas.cmd = 'changeNetwork';
            }
        },
        onSubmitSuccess: function onSubmitSuccess(response) {
            if (response.data.status === "success") {
                ...
                if (navigator.platform.indexOf("Win") !== -1) {
                    this.showTipText = L("修改成功", "iptalk");
                } else {
                    this.showTipText = L("修改成功，重启后生效", "iptalk");
                }
                var self = this;
                setTimeout(function () {
                    self.showTip = false;
        ...
        onSubmitError: function onSubmitError(response) {
            this.$set(this.formMeta, "submitErrorTip", response.data.errors);
        },
        onSubmitFail: function onSubmitFail(error) {
            if (navigator.platform.indexOf("Win") !== -1 && error.message === "Network Error") {
                var newIP = this.formData[0].ip;
                window.location = "http://" + newIP + ":85";
            }
        }
    },
    ...
    mounted: function mounted() {
        var self = this;
        this.$refs.netconfigform.showLoading();
        _webservice2.default.getJSON(urls.netConfig, {}).then(function (response) {
            self.formData = response.config_datas;
            self.formMeta.fields = response.config_fields;
            self.extraDatas = { cmd: 'changeNetwork', device: response.config_fields[0].group };
            self.$refs.netconfigform.hideLoading();
        }).catch(function (e) {
            alert(e);
        });
    }
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7293a06a\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/netconfig.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.netConfig[data-v-7293a06a] {/*\n        position: absolute;\n        transform: translate(-50%, 0);\n        top: 20%;\n        left: 50%;*/\n        width: 375px;\n        margin: 0 auto;\n        /*position: relative;*/\n        top: 20%;\n}\n.netConfig > span[data-v-7293a06a] {\n        text-align: center;\n        display: block;\n        margin-bottom: 20px;\n}\n.netConfig > span.title[data-v-7293a06a] {\n        font-weight: bold;\n        font-size: xx-large;\n}\n.netConfig > span.showTip[data-v-7293a06a] {\n        position: absolute;\n        margin: auto;\n        left: 0;\n        right: 0;\n        top: 0;\n        bottom: 0;\n        height: 1em; \n        line-height: 1em;\n        font-size: 1em;\n        \n        font-weight:bold;\n        color:#2185D0;\n}\n.netConfig .restart[data-v-7293a06a] {\n        text-align: center;\n}\n.netConfig .restart button[data-v-7293a06a] {\n        margin: 10px auto;\n        height: 100%;\n        transition: height 1s ease-in 1s;\n}\n.netConfig .fade-enter-active[data-v-7293a06a], .netConfig .fade-leave-active[data-v-7293a06a] {\n        transition: opacity 1s\n}\n.netConfig .fade-enter[data-v-7293a06a], .netConfig .fade-leave-active[data-v-7293a06a] {\n        opacity: 0\n}\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-7293a06a\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/netconfig.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "netConfig"
  }, [_c('richform', {
    ref: "netconfigform",
    attrs: {
      "meta": _vm.formMeta,
      "form-data": _vm.formData,
      "form-data-index": _vm.formDataIndex,
      "extraDatas": _vm.extraDatas
    },
    on: {
      "formSubmitSuccess": _vm.onSubmitSuccess,
      "formSubmitError": _vm.onSubmitError,
      "submitbefore": _vm.onBeforeSubmit,
      "formSubmitFailed": _vm.onSubmitFail
    }
  }), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "fade"
    ...
    staticClass: "showTip"
  }, [_vm._v(_vm._s(_vm.showTipText))]) : _vm._e()])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7293a06a", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7293a06a\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/netconfig.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7293a06a\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/netconfig.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("120afe24", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7293a06a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./netconfig.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7293a06a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./netconfig.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/apps/iptalk/manager/netconfig.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/netconfig.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-7293a06a\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/netconfig.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-7293a06a",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\apps\\iptalk\\manager\\netconfig.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] netconfig.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7293a06a", Component.options)
  } else {
    hotAPI.reload("data-v-7293a06a", Component.options)
  }
