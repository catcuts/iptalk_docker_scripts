...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/common/device/device.action.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
    ...
    computed: {
        actionList: function actionList() {
            return this.device.meta.actions.list;
        },
        actions: function actions() {
            var sortConfig = { enabled: true, key: "sequenceNo", order: "desc" };

            return this.sortListData(sortConfig, this.actionList);
        },
        richformMeta: function richformMeta() {
            var richformMeta = {};
            this.actions.forEach(function (action) {
                if (action.widgets) {
                    action.widgets.forEach(function (widget) {
                        try {
                            if (widget.props.formMeta) {
                                var richformMetaEle = (0, _deepAssign2.default)({
                                    border: false,
                                    header: { visible: false },
                                    footer: { visible: false }
                                }, widget.props.formMeta);
                                richformMeta[action.name] = richformMetaEle;
                            }
                        } catch (e) {}
                    });
                }
    ...
    methods: {
        ...
        onWidgetClick: function onWidgetClick(widget, action, $event) {
            if (typeof widget.click === "string") {
                this.dispatch(widget.click || "onWidgetClick", this.$parent.$parent.$props.meta.name, widget, action, $event);
            } else if (typeof widget.click === "function") {
                widget.click(widget, action, $event);
            }
        },
        onWidgetChange: function onWidgetChange(widget, action, $event) {
            if (typeof widget.change === "string") {
                this.dispatch(widget.change || "onWidgetChange", this.$parent.$parent.$props.meta.name, widget, action, $event);
            } else if (typeof widget.change === "function") {
                widget.change(widget, action, $event);
            }
        },
        onListItemClick: function onListItemClick(action, $event) {
            if (typeof action.click === "string") {
                this.dispatch(action.click || "onListItemClick", this.$parent.$parent.$props.meta.name, action, $event);
            } else if (typeof action.click === "function") {
                action.click(action, $event);
            }
        }
    },
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-70d8a7d8\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/device/device.action.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.vue-device-action .ui.list .item:first-child {\n    border-top: none;\n}\n.vue-device-action .ui.list .item:last-child {\n    border-bottom: none!important;\n}\n.vue-device-action .ui.list .item .content .header {\n    font-weight: normal;\n}\n.vue-device-action .ui.list .item .content .description {\n    font-size: .5em;\n}\n.vue-device-action .ui.list .item .right.floated.content i,\n.vue-device-action .ui.list .item .right.floated.content button {\n    margin-right: 0;\n}\n.vue-device-action .ui.list .item .right.floated.content .widget-richform .richform .richform-body {\n    height: auto!important;\n    padding: 0;\n}\n.vue-device-action .ui.list .item .right.floated.content .widget-richform .richform .richform-body .field {\n    margin-bottom: 0;\n}\n.vue-device-action .ui.list .item .right.floated.content .widget-richform .richform .richform-body .field .ui.input>input {\n    padding: 6px;\n}\n.vue-device-action .ui.list .item .right.floated.content .widget-richform .richform .richform-body .field .ui.dropdown {\n    min-height: 30px;\n    height: auto;\n    padding: 0;\n    min-width: 165px;\n}\n.vue-device-action .ui.list .item .right.floated.content button {\n    padding: 8px 6px;\n}\n\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-70d8a7d8\",\"hasScoped\":false}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/common/device/device.action.async.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "vue-device-action"
  }, [_c('div', {
    staticClass: "ui celled middle aligned list"
  }, _vm._l((_vm.actions), function(action) {
    return _c('a', {
      staticClass: "item",
      on: {
        "click": function($event) {
          _vm.onListItemClick(action, $event)
        }
      }
    }, [_c('div', {
      staticClass: "right floated content"
    }, _vm._l((action.widgets), function(widget) {
      return _c('div', {
        attrs: {
          "title": widget.tips
        },
        on: {
          "click": function($event) {
            _vm.onWidgetClick(widget, action, $event)
          },
          "change": function($event) {
            _vm.onWidgetChange(widget, action, $event)
          }
        }
      }, [(widget.type === 'icon') ? _c('i', {
        class: [widget.class, 'icon']
      }) : _vm._e(), _vm._v(" "), (widget.type === 'button') ? _c('button', {
        class: [widget.class, 'ui icon button']
      }, [_c('i', {
        class: [widget.props.icon, 'icon']
      }), _vm._v("\n                        " + _vm._s(widget.props.text) + "\n                    ")]) : _vm._e(), _vm._v(" "), (widget.type === 'richform') ? _c('div', {
        class: [widget.class, 'widget-richform']
      }, [_c('richform', {
        attrs: {
          "meta": _vm.richformMeta[action.name],
          "form-data": widget.props.formData
        }
      })], 1) : _vm._e()])
    })), _vm._v(" "), _c('i', {
    ...
    }, [_vm._v(_vm._s(action.title))]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-70d8a7d8", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-70d8a7d8\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/device/device.action.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("48eb0a18", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-70d8a7d8\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./device.action.async.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-70d8a7d8\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./device.action.async.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/common/device/device.action.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/common/device/device.action.async.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-70d8a7d8\",\"hasScoped\":false}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/common/device/device.action.async.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  null,
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\common\\device\\device.action.async.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] device.action.async.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-70d8a7d8", Component.options)
  } else {
    hotAPI.reload("data-v-70d8a7d8", Component.options)
  }
