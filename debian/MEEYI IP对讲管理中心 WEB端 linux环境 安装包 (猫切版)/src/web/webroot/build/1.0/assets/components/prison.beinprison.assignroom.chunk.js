...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.assignroom.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
	...
	watch: {
		areadata: function areadata(newValue, oldValue) {
			...
			if (newValue == "null") {
				this.roomFormMeta.fields[1].attrs.items.length = 0;
				this.roomFormMeta.fields[1].attrs.items.push({
					content: "清空",
					value: "null",
					icon: "edit"
				});
			} else {
				var _roomFormMeta$fields$;

				this.roomFormMeta.fields[1].attrs.items.length = 0;
				(_roomFormMeta$fields$ = this.roomFormMeta.fields[1].attrs.items).push.apply(_roomFormMeta$fields$, [{
					content: "清空",
					value: "null",
					icon: "edit"
		...
		roomdata: function roomdata(newValue, oldValue) {
			...
			this.item[1].dispatch('getRoomEmptyBedTable', newValue).then(function (response) {
				...
				if (newValue == self.roomonload) {
					var _self$roomFormMeta$fi;

					(_self$roomFormMeta$fi = self.roomFormMeta.fields[2].attrs.items).push.apply(_self$roomFormMeta$fi, [{
						content: "清空",
						value: "null",
						icon: "edit"
					}].concat(_toConsumableArray(self.beddataonload)));
				}
				(_self$roomFormMeta$fi2 = self.roomFormMeta.fields[2].attrs.items).push.apply(_self$roomFormMeta$fi2, bed);
			}).catch(function () {
				self.roomFormMeta.fields[2].attrs.items.length = 0;
				self.roomFormMeta.fields[2].attrs.items.push({
					content: "清空",
					value: "null",
					icon: "edit"
				});
	...
	methods: {
		...
		emitbedname: function emitbedname(newValue) {
			var self = this;
			var bedname;
			var beds = self.roomFormMeta.fields[2].attrs.items;
			for (var key in beds) {
	...
	created: function created() {
		...
		for (var areakey in this.item[2].children) {
			...
			this.roomFormMeta.fields[0].attrs.items.push({
				content: this.item[2].children[areakey].label,
				value: this.item[2].children[areakey].id,
				icon: "edit"
			});
			for (var roomkey in this.item[2].children[areakey].children) {
				this.rooms[this.item[2].children[areakey].id].push({
					content: this.item[2].children[areakey].children[roomkey].label,
					value: this.item[2].children[areakey].children[roomkey].id,
					icon: "edit"
				});
			}
		}
		if (this.areadata) {
			var _roomFormMeta$fields$2;

			this.roomFormMeta.fields[1].attrs.items.length = 0;
			(_roomFormMeta$fields$2 = this.roomFormMeta.fields[1].attrs.items).push.apply(_roomFormMeta$fields$2, [{
				content: "清空",
				value: "null",
				icon: "edit"
		...
		if (this.item[0].row.bed) {
			...
			self.roomFormMeta.fields[2].attrs.items[0] = {
				content: "清空",
				value: "null",
				icon: "edit"
			};
			self.roomFormMeta.fields[2].attrs.items.push({ content: this.item[3].bed_name, value: this.item[3].bed_number, icon: "edit" });
		}

		if (this.item[0].row.room) {
			var self = this;
			this.item[1].dispatch('getRoomEmptyBedTable', this.item[0].row.room).then(function (response) {
				var _self$roomFormMeta$fi3;
				...
				(_self$roomFormMeta$fi3 = self.roomFormMeta.fields[2].attrs.items).push.apply(_self$roomFormMeta$fi3, bed);
			});
		}
	},
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7991645b\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=1!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.assignroom.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\r\n/*弹窗的下拉不被遮挡*/\n.assignroom.rich-dialog:not(.minimize)>.rich-dialog-content {\r\n\toverflow: visible!important;\n}\r\n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7991645b\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.assignroom.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-7991645b\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.assignroom.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "assignroom"
  }, [_c('richform', {
    ref: "appform",
    staticClass: "assignroom",
    attrs: {
      "meta": _vm.roomFormMeta,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7991645b", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7991645b\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=1!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.assignroom.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("a15d3762", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7991645b\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!../../../../utils/lang-loader.js!./prison.beinprison.assignroom.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7991645b\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!../../../../utils/lang-loader.js!./prison.beinprison.assignroom.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7991645b\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.assignroom.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("ddbe2d8a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7991645b\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./prison.beinprison.assignroom.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7991645b\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./prison.beinprison.assignroom.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/devices/operates/prison/prison.beinprison.assignroom.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.assignroom.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-7991645b\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.assignroom.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-7991645b",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\devices\\operates\\prison\\prison.beinprison.assignroom.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] prison.beinprison.assignroom.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7991645b", Component.options)
  } else {
    hotAPI.reload("data-v-7991645b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
