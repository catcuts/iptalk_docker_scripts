...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.newcomer.register.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
	...
	data: function data() {
		...
		return {
			...
			photoFormMeta: {
				...
				fields: [{
					name: "photo",
					emiturl: "prison.noticetochangephotostatus",
					type: "imagefile",
					label: L("照片"),
					labelWidth: "95%",
					...
					default: "",
					placeholder: "",
					url: "/mock" + "/v1/webfrontend/prisoners/?_csrf={{ ctx.csrf | safe }}&portrait=true&number=",

					required: true,
					attrs: {
						max: 1,
						multiple: false,
						MIMEtype: "image/jpeg,image/gif,image/png,image/bmp",
						previewEnabled: true,
						previewOpts: {
							width: 350,
							height: 280
			...
			registerFormMeta: {
				...
				fields: [[{
					...
					attrs: { lazy: false },
					required: true
				}, "validation", ["empty", "maxLength[3]", 'regExp[/^[1-9][0-9]{0,2}$/]']), {
					name: "gender",
					type: "dropdown",
					label: L("性别"),
					showLabel: true,
					...
					enabled: true,
					validation: "empty"
				}, _defineProperty(_ref2, "required", true), _defineProperty(_ref2, "attrs", {
					enabled: true,
					multiple: false,
					search: true,
					iconPos: "float",
					...
					label: L("身份证"),
					labelWidth: "92%",
					validation: ["empty", 'regExp[/^[0-9]{17}[0-9|x|X]$/]'],
					width: 5,
					showLabel: true,
					default: "",
					placeholder: "",
					attrs: { lazy: false, icon: "" },
					required: true
				}, {
					name: "number",
					type: "text",
					label: L("编号"),
					validation: ["empty", "maxLength[12]"],
					labelWidth: "85%",
					width: 6,
					showLabel: true,
					default: "",
					...
					validation: "empty",
					group: "test"
				}, _defineProperty(_ref3, "required", false), _defineProperty(_ref3, "attrs", {
					enabled: true,
					multiple: false,
					search: false,
					iconPos: "float",
					...
					validation: "empty",
					group: "test"
				}, _defineProperty(_ref4, "required", false), _defineProperty(_ref4, "attrs", {
					multiple: false,
					search: false,
					enabled: true,
					iconPos: "float",
					...
					validation: "empty",
					group: "test"
				}, _defineProperty(_ref5, "required", false), _defineProperty(_ref5, "attrs", {
					multiple: false,
					search: false,
					enabled: true,
					iconPos: "float",
					...
					placeholder: "",
					attrs: {}
				}, _defineProperty(_ref6, "validation", "empty"), _defineProperty(_ref6, "required", true), _ref6), {
					name: "accusation",
					type: "text",
					label: L("犯罪行为"),
					labelWidth: "85%",
	...
	watch: {
		areadata: function areadata(newValue, oldValue) {
			$('.ui.dropdown.rooms').dropdown("clear");
			_vue2.default.set(this.personFormData, "room", "null");
			if (newValue == "null") {
				this.registerFormMeta.fields[2][1].attrs.items.length = 0;
				this.registerFormMeta.fields[2][1].attrs.items.push({
					content: "清空",
					value: "null",
					icon: "edit"
				});
			} else {
				var _registerFormMeta$fie;

				this.registerFormMeta.fields[2][1].attrs.items.length = 0;
				(_registerFormMeta$fie = this.registerFormMeta.fields[2][1].attrs.items).push.apply(_registerFormMeta$fie, [{
					content: "清空",
					value: "null",
					icon: "edit"
				}].concat(_toConsumableArray(this.rooms[newValue])));
			}
		},

		roomdata: function roomdata(newValue, oldValue) {
			var self = this;
			_vue2.default.set(this.personFormData, "bed", "null");
			$('.ui.dropdown.beds').dropdown("clear");
			this.item[1].dispatch('getRoomEmptyBedTable', newValue).then(function (response) {
				var _self$registerFormMet;

				var len = response.length;
				var bed = [];
				for (var i = 0; i < len; i++) {
					bed[i] = { content: response[i].bed_name, value: response[i].bed_number, icon: "edit" };
				}
				self.registerFormMeta.fields[2][2].attrs.items.length = 0;
				(_self$registerFormMet = self.registerFormMeta.fields[2][2].attrs.items).push.apply(_self$registerFormMet, [{
					content: "清空",
					value: "null",
					icon: "edit"
				}].concat(bed));
				...
				self.registerFormMeta.fields[2][2].attrs.items.length = 0;
				self.registerFormMeta.fields[2][2].attrs.items.push({
					content: "清空",
					value: "null",
					icon: "edit"
				});
	...
	computed: {
		areadata: function areadata() {
			return this.personFormData.area;
		},
		roomdata: function roomdata() {
			return this.personFormData.room;
		},

		province: function province() {
			var provi = ["北京市", "天津市", "河北省", "山西省", "内蒙古自治区", "辽宁省", "吉林省", "黑龙江省", "上海市", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西壮族自治区", "海南省", "重庆市", "四川省", "贵州省", "云南省", "西藏自治区", "陕西省", "甘肃省", "青海省", "宁夏回族自治区", "新疆维吾尔自治区", "台湾省", "香港特别行政区", "澳门特别行政区"];
			var province = [];
			for (var item in provi) {
				province[item] = { content: provi[item], value: provi[item], icon: "edit" };
			}
			return province;
		}
	},
	methods: {
		...
		onNext: function onNext(inst) {
			var self = this;
			if (this.personFormData.name && this.personFormData.accusation && this.personFormData.prison_term && this.personFormData.gender && this.personFormData.into_jail_date && this.personFormData.age && this.personFormData.birthplace && this.personFormData.number && this.personFormData.family_address && this.personFormData.identity_id) {
				if (self.status != "shootphoto") {
					if (self.validstatus.validstatus == true) {
						this.savepersonregister().then(function (response) {
							if (response.status === 'success') {
								self.item[2].footer.buttons[8].visible = false;
								self.item[2].footer.buttons[4].text = "完成";

								self.photoFormMeta.fields[0].url = self.photoFormMeta.fields[0].url + self.personFormData.number;
								self.photoFormMeta.fields[0].attrs.uploadOpts.data = self.personFormData.number;
								self.status = "shootphoto";


								self.item[1].dispatch('getbeinprisonList', { newPage: 1, pageSize: self.item[4].pageSize, filter: "new" }).then(function (result) {
									self.item[4].pageCount = result.pageCount;
									self.item[4].pageSize = result.pageSize;
									self.item[4].pageNumber = 1;
								});
			...
			if (this.status == "shootphoto" && this.photoFormData.photo) {
				this.status = "complete";
				self.item[2].footer.buttons[4].visible = false;
				this.item[2].footer.buttons[8].icon = "edit";
				this.item[2].footer.buttons[8].visible = false;
				this.item[2].footer.buttons[9].visible = false;
				this.item[2].footer.buttons[10].visible = false;
				inst.destroy();
				toast('已完成人员登记');
			} else if (this.status == "shootphoto" && !this.photoFormData.photo) {
				toast('请上传人员照片', 650);
			}
		},
		onBack: function onBack() {
			if (this.status == "shootphoto") {
				this.status = "register";
				this.item[2].footer.buttons[8].visible = false;
			} else if (this.status == "fingerprints") {
				this.photoFormData.photo = false;
				this.status = "shootphoto";
				this.photoFormData.photo = "";
				this.item[2].footer.buttons[8].icon = "edit";
				this.item[2].footer.buttons[8].visible = true;
				this.item[2].footer.buttons[9].visible = false;
				this.item[2].footer.buttons[10].visible = false;
			} else if (this.status == "assigncard") {
				this.finger.leftFinger = "";
				this.finger.rightFinger = "";
				this.status = "fingerprints";
				this.item[2].footer.buttons[4].text = "下一步";
				this.item[2].footer.buttons[9].visible = true;
				this.item[2].footer.buttons[10].visible = true;
				this.item[2].footer.buttons[11].visible = false;
			}
		},
		shootPhoto: function shootPhoto() {
			this.item[2].footer.buttons[8].icon = "checkmark";
			this.item[1].dispatch('shootphoto', { number: this.personFormData.number, photoFormData: this.photoFormData });
		},
		onResetInput: function onResetInput() {
			for (var i in this.personFormData) {
				this.personFormData[i] = "";
			}
		},
		savepersonregister: function savepersonregister() {
			return this.item[1].dispatch('submitnewpersoninfo', this.personFormData);
		}
	},
	created: function created() {
		var self = this;

		_eventbus2.default.$on('prison.noticetochangephotostatus', function () {
			self.photoFormData.photo = true;
		});

		for (var areakey = 0; areakey < this.item[3].children.length; areakey++) {
			this.$set(this.rooms, this.item[3].children[areakey].id, []);
			this.registerFormMeta.fields[2][0].attrs.items.push({
				content: this.item[3].children[areakey].label,
				value: this.item[3].children[areakey].id,
				icon: "edit"
			});
			for (var roomkey in this.item[3].children[areakey].children) {
				this.rooms[this.item[3].children[areakey].id].push({
					content: this.item[3].children[areakey].children[roomkey].label,
					value: this.item[3].children[areakey].children[roomkey].id,
					icon: "edit"
				});
			}
		}
		if (this.areadata) {
			this.registerFormMeta.fields[2][1].attrs.items = this.rooms[this.areadata];
		}

		this.registerFormMeta.fields[1][0].attrs.items = this.province;
	},
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c112cc8e\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=1!./utils/lang-loader.js!./src/devices/operates/prison/prison.newcomer.register.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.newcomer-register .formclass .ui.attached.segment {\r\n\theight: 140px;\n}\n.newcomer-register .assignroom .ui.attached.segment {\r\n\tborder: none\n}\r\n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c112cc8e\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.newcomer.register.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.newcomer-register .becompact[data-v-c112cc8e] {\r\n\twidth: 12%\n}\n.newcomer-register .cardbutton[data-v-c112cc8e] {\r\n\tfloat: right;\r\n\tmargin: 10px 20px 10px 0\n}\n.newcomer-register .assignroom[data-v-c112cc8e] {\r\n\twidth: 46%;\r\n\tmargin: 10px 2px;\r\n\tfloat: right\n}\n.newcomer-register .border[data-v-c112cc8e] {\r\n\tborder: solid 1px #d4d4d5;\r\n\tborder-radius: 5px;\r\n\tmargin-top: 10px\n}\n.newcomer-register .table .tds[data-v-c112cc8e] {\r\n\tbackground-color: #f8f7f7;\r\n\twidth: 25%;\r\n\tfont-weight: bold;\n}\n.newcomer-register .table[data-v-c112cc8e] {\r\n\t/*top: 60px;*/\r\n\twidth: 28%;\r\n\t/*height: calc(100% - 70px);*/\r\n\tborder: 1px solid #e5e5e5;\r\n\tmargin: 15px auto;\r\n\tpadding: 1px;\r\n\tbackground-color: #fff;\r\n\tborder-radius: 5px 5px 0 5px;\n}\n.newcomer-register .table td[data-v-c112cc8e] {\r\n\t/*top: 60px;*/\r\n\t/*height: calc(100% - 70px);*/\r\n\twidth: 25%;\r\n\tborder: 1px solid #e5e5e5;\r\n\t/*margin: 10px;*/\r\n\tpadding: 5px;\r\n\tbackground-color: #fff;\r\n\tborder-radius: 5px 5px 0 5px;\n}\n.newcomer-register .footer[data-v-c112cc8e] {\r\n\ttop: 370px;\r\n\t/*height:20px;*/\r\n\t/*border: 0px solid #e5e5e5;*/\r\n\tborder: 0px;\r\n\tmargin: 5px;\r\n\tpadding: 1px;\r\n\tbackground-color: #fff;\r\n\t/*border-radius: 5px 5px 0 5px;*/\n}\n.newcomer-register .footer .form-button[data-v-c112cc8e] {\r\n\tmargin: 5px 14px;\r\n\twidth: 110px;\n}\r\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-c112cc8e\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.newcomer.register.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "newcomer-register"
  }, [(_vm.status == 'register') ? _c('div', [_vm._m(0), _vm._v(" "), _c('div', {
    staticClass: "ui fluid"
  }, [_c('richform', {
    ref: "appform",
    attrs: {
      "meta": _vm.registerFormMeta,
      "validstatus": _vm.validstatus.validstatus,
      "before-submit": _vm.cancelsubmit,
      "form-data": [_vm.personFormData]
    },
    on: {
      "update:validstatus": function($event) {
        _vm.validstatus.validstatus = $event
      }
    }
  })], 1)]) : _vm._e(), _vm._v(" "), (_vm.status == 'shootphoto') ? _c('div', [_vm._m(1), _vm._v(" "), _c('div', {
    staticClass: "ui fluid"
  }, [_c('div', {
    staticStyle: {
      "padding": "50px 10px"
    ...
    attrs: {
      "meta": _vm.photoFormMeta
    }
  })], 1)])]) : _vm._e(), _vm._v(" "), (_vm.status == 'complete') ? _c('div', [_vm._m(2), _vm._v(" "), _c('div', {
    staticClass: "ui fluid"
  }, [_c('div', {
    staticStyle: {
      "padding": "50px 10px"
  ...
  return _c('div', {
    staticClass: "ui ordered stackable tablet five  steps"
  }, [_c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("录入基本信息")])])]), _vm._v(" "), _c('div', {
    staticClass: "disabled step"
  }, [_c('div', {
    staticClass: "content"
  }, [_c('div', {
    staticClass: "title"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c112cc8e", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c112cc8e\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=1!./utils/lang-loader.js!./src/devices/operates/prison/prison.newcomer.register.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("1d53747a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c112cc8e\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!../../../../utils/lang-loader.js!./prison.newcomer.register.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c112cc8e\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!../../../../utils/lang-loader.js!./prison.newcomer.register.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c112cc8e\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.newcomer.register.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("6dd33298", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c112cc8e\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./prison.newcomer.register.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c112cc8e\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./prison.newcomer.register.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/devices/operates/prison/prison.newcomer.register.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.newcomer.register.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-c112cc8e\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.newcomer.register.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-c112cc8e",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\devices\\operates\\prison\\prison.newcomer.register.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] prison.newcomer.register.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c112cc8e", Component.options)
  } else {
    hotAPI.reload("data-v-c112cc8e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
