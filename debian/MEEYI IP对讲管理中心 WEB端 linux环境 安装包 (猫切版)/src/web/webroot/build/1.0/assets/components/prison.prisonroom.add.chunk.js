...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.prisonroom.add.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
	...
	data: function data() {
		return {
			...
			editPrison: [{
				...
				showLabel: true,
				default: "佚名",
				placeholder: "请输入新的监狱名",
				help: "html文本",
				required: true,
				labelColor: "green",
				width: 10,
				validation: ["empty", "maxLength[15]"],
				attrs: {
					lazy: false,
					icon: "edit"
				}
			...
			addBunk: [[{
				...
				showLabel: true,
				default: "佚名",
				placeholder: "请输入新的床位名称",
				help: "html文本",
				required: true,
				labelColor: "green",
				width: 10,
				validation: ["empty", "maxLength[8]"],
				attrs: {
					lazy: false,
					icon: "edit"
				}
	...
	created: function created() {
		...
		var nItem = new Array();
		if (that.operateObj) {
			var e = that.operateObj.type;
			that.formMeta.fields = that[e];
		}
		if (that.operateObj.type == "editPrison") {
			that.item[0].areaName = that.prisonTree.label;
		}
		if (that.operateObj.showId) {
			if (that.operateObj.showId == '0') {
				if (that.operateObj.type == "editArea") {
					for (var i = 0; i < that.operateObj.bedListData.length; i++) {
						if (that.operateObj.bedListData[i].id == that.operateObj.selectGroup[0]) {
							that.item[0].areaName = that.operateObj.bedListData[i].label;
							var areas = that.operateObj.selectGroup[0].split('');
							that.item[0].area1 = areas[1];
							that.item[0].area2 = areas[2];
						}
					}
				}
				for (var _i = 0; _i < that.formMeta.fields.length; _i++) {
					if (that.formMeta.fields[_i].name == 'copyarea') {
						for (var j = 0; j < that.prisonTree.children.length; j++) {
							that.formMeta.fields[_i].attrs.items.push({
								content: that.prisonTree.children[j].label,
								value: that.prisonTree.children[j].id,
								icon: "edit"
							});
						}
					}
				}
			} else if (that.operateObj.showId.length == '3') {

				if (that.operateObj.type == "editRoom") {
					for (var _i2 = 0; _i2 < that.operateObj.bedListData.length; _i2++) {
						if (that.operateObj.bedListData[_i2].id == that.operateObj.selectGroup[0]) {
							that.item[0].areaName = that.operateObj.bedListData[_i2].label;
							var _areas = that.operateObj.selectGroup[0].split('');
							that.item[0].room1 = _areas[_areas.length - 3];
							that.item[0].room2 = _areas[_areas.length - 2];
							that.item[0].room3 = _areas[_areas.length - 1];
						}
					}
				}

				for (var _i3 = 0; _i3 < that.formMeta.fields.length; _i3++) {
					if (that.formMeta.fields[_i3].name == 'copyarea') {
						for (var k = 0; k < that.prisonTree.children.length; k++) {
							if (that.prisonTree.children[k].id == that.operateObj.showId) {
								for (var _j = 0; _j < that.prisonTree.children[k].children.length; _j++) {
									that.formMeta.fields[_i3].attrs.items.push({
										content: that.prisonTree.children[k].children[_j].label,
										value: that.prisonTree.children[k].children[_j].id,
										icon: "edit"
									});
								}
							}
			...
			} else if (that.operateObj.showId.length == '6') {
				if (that.operateObj.bedListData) {
					for (var _j2 = 0; _j2 < that.operateObj.bedListData.length; _j2++) {
						if (that.operateObj.bedListData[_j2].bed_number == that.operateObj.selectGroup[0]) {
							that.item[0].bunkEnable = that.operateObj.bedListData[_j2].enable;
							that.item[0].areaName = that.operateObj.bedListData[_j2].bed_name;
							var _areas2 = that.operateObj.selectGroup[0].split('');
							that.item[0].bed1 = _areas2[_areas2.length - 2];
							that.item[0].bed2 = _areas2[_areas2.length - 1];
						}
					}
				}
			}
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08d28e13\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=1!./utils/lang-loader.js!./src/devices/operates/prison/prison.prisonroom.add.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08d28e13\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.prisonroom.add.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-08d28e13\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.prisonroom.add.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "prisonroom-add"
  }, [_c('div', [_c('richform', {
    ref: "appform",
    attrs: {
      "meta": _vm.formMeta,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-08d28e13", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08d28e13\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=1!./utils/lang-loader.js!./src/devices/operates/prison/prison.prisonroom.add.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("8a722db2", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08d28e13\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!../../../../utils/lang-loader.js!./prison.prisonroom.add.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08d28e13\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!../../../../utils/lang-loader.js!./prison.prisonroom.add.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08d28e13\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.prisonroom.add.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("0c97cffb", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08d28e13\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./prison.prisonroom.add.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-08d28e13\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./prison.prisonroom.add.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/devices/operates/prison/prison.prisonroom.add.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.prisonroom.add.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-08d28e13\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.prisonroom.add.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-08d28e13",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\devices\\operates\\prison\\prison.prisonroom.add.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] prison.prisonroom.add.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-08d28e13", Component.options)
  } else {
    hotAPI.reload("data-v-08d28e13", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
