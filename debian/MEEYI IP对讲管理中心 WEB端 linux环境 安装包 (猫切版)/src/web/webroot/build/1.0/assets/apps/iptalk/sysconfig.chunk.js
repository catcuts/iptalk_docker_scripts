...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/sysconfig.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
    ...
    mixins: [],
    data: function data() {
        var isWinPlatform = navigator.platform.indexOf("Win") !== -1;
        return {
            configs: [],
            selected: -1,
            fieldAddInfo: {
                voerka: { translation: "voerka", remarkText: "", readOnly: false } },
            loading: true,
            formMeta: {
                url: urls.sysConfig,
                method: "post",
                ...
                footer: {
                    default: false,
                    items: [{ name: "submit", text: L("提交", "iptalk"), classs: "primary submit", icon: "checkmark", tips: L("提交表单", "iptalk"), click: "submit" }, { name: "restart", text: L("立即重启", "iptalk"), classs: "primary", icon: "refresh", tips: L("立即重启", "iptalk"), click: function click() {
                            this.$parent.$parent.onRestart();
                        } }, { name: "correct", text: L("校正时间", "iptalk"), classs: "primary", icon: "history", tips: L("校正时间", "iptalk"), click: function click() {
                            this.$parent.$parent.onCorrectServerTime();
                        }, visible: !isWinPlatform }]
                },
                fields: []
            },
            formData: [{}],
    ...
    methods: {
        ...
        onCorrectServerTime: function onCorrectServerTime() {
            _axios2.default.get(urls.sysCorrectTime, { params: { time: this.getCurrentTime() } });
            this.raiseTip("校正成功");
        },
        raiseTip: function raiseTip(tip) {
            this.tip = tip;
            this.showTip = true;
            var self = this;
            setTimeout(function () {
        ...
        getCurrentTime: function getCurrentTime() {
            ...
            var formatedDate = dateInfo.ymd + " " + dateInfo.hws;
            return formatedDate;
        }
    },
    ...
    mounted: function mounted() {
        var self = this;
        this.$refs.sysconfigform.showLoading();
        _webservice2.default.getJSON(urls.sysConfig, {}).then(function (response) {
            self.formData = response.config_datas;
            self.formMeta.fields = response.config_fields;

            self.$refs.sysconfigform.hideLoading();
        });
    }
};
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-744188fb\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/sysconfig.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.sysConfig .title[data-v-744188fb] {\n    display: inline-block;\n    margin: 5px auto 0 10px;\n    font-weight: 700;\n}\n.sysConfig .fade-enter-active[data-v-744188fb], .sysConfig .fade-leave-active[data-v-744188fb] {\n    transition: opacity 1s\n}\n.sysConfig .fade-enter[data-v-744188fb], .sysConfig .fade-leave-active[data-v-744188fb] {\n    opacity: 0\n}\n.sysConfig .showTip[data-v-744188fb] {\n    position: fixed;\n    top: 50%;\n    left: 50%;\n    color: white;\n    background: rgba(0,0,0,0.5);\n    border-radius: 4px;\n    padding: 1em;\n    cursor: pointer;\n}\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-744188fb\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/sysconfig.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "sysConfig"
  }, [_c('richform', {
    ref: "sysconfigform",
    attrs: {
      "meta": _vm.formMeta,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-744188fb", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-744188fb\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/sysconfig.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-744188fb\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/sysconfig.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("39b726d7", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-744188fb\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./sysconfig.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-744188fb\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./sysconfig.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/apps/iptalk/manager/sysconfig.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/sysconfig.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-744188fb\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/sysconfig.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-744188fb",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\apps\\iptalk\\manager\\sysconfig.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] sysconfig.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-744188fb", Component.options)
  } else {
    hotAPI.reload("data-v-744188fb", Component.options)
  }
