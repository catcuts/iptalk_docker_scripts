...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/common/auth/forgetpassword.vue":
...
exports.default = {
	...
	methods: {
		getphoneauthcode: function getphoneauthcode(username, phone) {
			var data = { username: username, phone: phone };
			_webservice2.default.getJSON(_urls.forgetpassword, data).then(function (response) {
				if (response.status == "success") {
					toast(response.message);
				} else {
					$('.ui.form').form('add errors', [response.message]);
				}
			});
		},
		reload: function reload(msg) {
			window.location.reload();
		}
	},
	mounted: function mounted() {
		(0, _common.detectBack)();
		_eventbus2.default.$on("moduls.auth.forgetpassword.reload", this.reload);
		var that = this;
		$(".ui.form").form({
			on: 'submit',
			inline: false,
			...
			onSuccess: function onSuccess(event, fields) {
				var data = { username: that.username, phone: that.phone, authcode: that.authcode };

				_webservice2.default.getJSON(_urls.forgetpassword, data, function (response) {
					if (response.status == "success") {
						alert(response.message, _eventbus2.default.$emit("moduls.auth.resetpassword", "B"));
					} else {
						$('.ui.form').form('add errors', [response.message]);
					}
				}).fail(function (e) {
		...
		$(this.$el).find('.segment').hover(function (event) {
			$(this).css("opacity", 1);
		}, function (event) {
			$(this).css("opacity", .7);
		});
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/common/auth/passport.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var _forgetpassword = __webpack_require__("./src/common/auth/forgetpassword.vue");

var _forgetpassword2 = _interopRequireDefault(_forgetpassword);

var _resetpassword = __webpack_require__("./src/common/auth/resetpassword.vue");
...
exports.default = {
	components: { menubar: _menubar2.default, layout: _layout2.default, forgetpwd: _forgetpassword2.default, resetpassword: _resetpassword2.default },
	computed: _extends({}, (0, _vuex.mapState)({
		theme: function theme(state) {
			return state.theme;
		}
	...
	data: function data() {
		return {
			infoicon: __webpack_require__("./src/assets/images/alarmicons/info.png"),
			type: "A"
		};
	},
	created: function created() {
		_eventbus2.default.$on("moduls.auth.resetpassword", this.changetype);
	},

	methods: {
		changetype: function changetype(msg) {
			this.type = msg;
		},
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/common/auth/resetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
	...
	mounted: function mounted() {
		(0, _common.detectBack)();
		_eventbus2.default.$on("moduls.auth.resetpassword.reload", this.reload);
		this.getAuthCode();
		var that = this;
		$(".ui.form").form({
			on: 'submit',
			...
			fields: {
				password: {
					identifier: 'password',
					rules: [{
						type: 'regExp[/^[a-zA-Z0-9]{6,12}$/]',
						prompt: '密码必须是6-12位数字、字母或组合，不能包含特殊字符'
					}]
				},
				checkpassword: {
				...
				authcode: {
					...
					rules: [{
						...
						prompt: '验证码必须是4位数字、字母或组合，不能包含特殊字符'
					}]
				}
			},
			onSuccess: function onSuccess(event, fields) {
				var data = { password: that.password, checkpassword: that.checkpassword, captcha: that.authcode };
				_webservice2.default.getJSON(_urls.resetpassword, data, function (response) {
					if (response.status == "success") {
						alert(response.message, that.$router.push("/login"), _eventbus2.default.$emit("moduls.auth.login.reload"));
					} else {
						$('.ui.form').form('add errors', [response.message]);
					}
				}).fail(function (e) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57f3b990\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/passport.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n#header[data-v-57f3b990]{\r\n    width:100%;\r\n    height: 100px;\r\n    background-color: #f0f0f0;\r\n    border-bottom:1px solid #e3e3e3;\n}\n.header-layout[data-v-57f3b990]{\r\n    width:990px;\r\n    margin:0 auto;\r\n    padding:30px 0;\r\n    overflow: hidden;\n}\n#logo[data-v-57f3b990]{\r\n    background-position:0 -12px;\r\n    background-image: url(" + __webpack_require__("./src/assets/images/logo.jpg") + ");\r\n    background-repeat: no-repeat;\r\n    float:left;\r\n    display: inline-block;\r\n    height: 40px;\r\n    width: 253px; \r\n    margin:0px;\n}\n.logo-title[data-v-57f3b990]{\r\n    float: left;\r\n    display:inline-block;\r\n    width:auto;\r\n    height:30px;\r\n    padding:5px 0 0 10px;\r\n    line-height:30px;\r\n    font-size:24px;\r\n    color: #303030;\r\n    margin:0px;\n}\n.header-nav[data-v-57f3b990]{\r\n    width:auto;\r\n    height:14px;\r\n    float: right;\r\n    line-height:14px;\r\n    margin-top:12px;\n}\n.nav-first[data-v-57f3b990]{\r\n    border-left:0px;\r\n    float: left;\r\n    padding: 0 0 0 15px;\r\n    margin-right:15px;\n}\n.header-nav li a[data-v-57f3b990]{\r\n    color:#6c6c6c;\n}\na[data-v-57f3b990]:hover, a[data-v-57f3b990]:visited{\r\n    color:#f40;\r\n    text-decoration:underline;\n}\nul[data-v-57f3b990]{\r\n    list-style:none;\n}\n#content[data-v-57f3b990]{\r\n    width:100%;\r\n    min-height:500px;\r\n    border-top:1px solid #fff;\r\n    padding:50px 0;\n}\n.maincenter[data-v-57f3b990]{\r\n    margin: 0 auto;\r\n    width: 774px;\r\n    height: auto;\n}\n.tips-icon[data-v-57f3b990]{\r\n    width: 20px;\r\n    height: 20px;\n}\n.tip-text[data-v-57f3b990]{\r\n    text-shadow: 0 1px 0 #fff;\r\n    color: #6c6c6c;\n}\n.footer[data-v-57f3b990]{\r\n    text-align: center;\r\n    text-shadow: 0 1px 0 #fff;\r\n    color: #858585;\n}\r\n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-654b5c98\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/resetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\t/*.resetpassword{\n\t\tposition: relative;\n\t\twidth: 100%;\n\t\theight: 100%;\n\t\toverflow: auto;\n\t}\n\t.container{\n\t\tbackground-image: url(../../../assets/images/login.jpg);\n\t\tbackground-repeat: no-repeat;\n\t\tbackground-position: center;\n\t\tbackground-size: 1127px,643px;\n\t\twidth: 1127px;\n\t\theight: 100%;\n\t}\n\t#user{\n\t\tleft: 700px;\n\t\ttop:400px;\n\t}*/\n.segment[data-v-654b5c98]{\n\t\tpadding: 7px!important;\n\t\topacity: .7;\n}\n.segment .field[data-v-654b5c98]{\n\t\tmargin: 0 0 .7em!important;\n}\n\t/*.form{\n\t\ttop:400px;\n\t\tleft:255px;\n\t\theight: 234px;\n\t}*/\n.form[data-v-654b5c98]{\n\t\ttop:80px;\n}\n\t/*.column {\n      \tmax-width: 350px;\n    }*/\n.grid[data-v-654b5c98]{\n\t\theight: 100%;\n}\n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f9792da4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/forgetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.segment[data-v-f9792da4]{\n\t\tpadding: 7px!important;\n\t\topacity: .7;\n}\n.segment .field[data-v-f9792da4]{\n\t\tmargin: 0 0 .7em!important;\n}\n\t/*.form{\n\t\ttop:400px;\n\t\tleft:255px;\n\t\theight: 234px;\n\t}*/\n.form[data-v-f9792da4]{\n\t\ttop:80px;\n}\n\t/*.message{\n\t\ttop:660px;\n\t\tleft:280px;\n\t\theight: 65px;\n\t\tbox-shadow: none!important;\n\t}*/\n.grid[data-v-f9792da4]{\n\t\theight: 100%;\n}\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-57f3b990\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/common/auth/passport.vue":
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
  ...
  }), _vm._v(" "), (_vm.type === 'A') ? _c('h2', {
    staticClass: "logo-title"
  }, [_vm._v(" 找回密码 ")]) : _c('h2', {
    staticClass: "logo-title"
  }, [_vm._v(" 重置密码 ")]), _vm._v(" "), _c('ul', {
    staticClass: "header-nav"
  }, [_c('li', {
    staticClass: "nav-first"
  }, [_c('a', {
    on: {
      "click": function($event) {
        _vm.onlogin()
    ...
    staticClass: "maincenter"
  }, [_c('img', {
    staticClass: "tips-icon",
    attrs: {
      "src": _vm.infoicon
    }
  }), _vm._v(" "), (_vm.type === 'A') ? _c('span', {
    staticClass: "tip-text"
  }, [_vm._v("请输入你需要找回登录密码的账户名和手机号码")]) : _c('span', {
    staticClass: "tip-text"
  }, [_vm._v("请输入新的密码")]), _vm._v(" "), (_vm.type === 'A') ? _c('forgetpwd') : _c('resetpassword')], 1)]), _vm._v(" "), _c('div', {
    staticClass: "footer"
  }, [_vm._v("\n        环宇通版权所有 2017-2021 | 闽ICP备16038990号-2\n    ")])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-57f3b990", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-654b5c98\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/common/auth/resetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "checkmark box icon"
  }), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    staticClass: "ui fluid large red submit button"
  }, [_vm._v("提交")])]), _vm._v(" "), _c('div', {
    staticClass: "ui error message right center popup",
    staticStyle: {
      "position": "absolute",
      "z-index": "999",
      "left": "320px",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-654b5c98", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-f9792da4\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/common/auth/forgetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": function($event) {
        _vm.getphoneauthcode(_vm.username, _vm.phone)
      }
    }
  }, [_vm._v("获取")])])]), _vm._v(" "), _c('div', {
    staticClass: "ui fluid large red submit button"
  }, [_vm._v("提交")])]), _vm._v(" "), _c('div', {
    staticClass: "ui error message right center popup",
    staticStyle: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-f9792da4", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57f3b990\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/passport.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57f3b990\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/passport.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("65499747", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57f3b990\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./passport.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57f3b990\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./passport.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-654b5c98\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/resetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-654b5c98\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/resetpassword.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("f0ac4658", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-654b5c98\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./resetpassword.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-654b5c98\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./resetpassword.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f9792da4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/forgetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f9792da4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/forgetpassword.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("74f92a0e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f9792da4\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./forgetpassword.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f9792da4\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./forgetpassword.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
module.exports = __webpack_require__.p + "images/logo.da110d.jpg";
...
/***/ "./src/common/auth/forgetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/common/auth/forgetpassword.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-f9792da4\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/common/auth/forgetpassword.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-f9792da4",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\common\\auth\\forgetpassword.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f9792da4", Component.options)
  } else {
    hotAPI.reload("data-v-f9792da4", Component.options)
  }
...
/***/ "./src/common/auth/passport.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__("./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-57f3b990\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/passport.vue")
}
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/common/auth/passport.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-57f3b990\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/common/auth/passport.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-57f3b990",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\common\\auth\\passport.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-57f3b990", Component.options)
  } else {
    hotAPI.reload("data-v-57f3b990", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/***/ "./src/common/auth/resetpassword.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__("./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-654b5c98\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/common/auth/resetpassword.vue")
}
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/common/auth/resetpassword.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-654b5c98\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/common/auth/resetpassword.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-654b5c98",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\common\\auth\\resetpassword.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-654b5c98", Component.options)
  } else {
    hotAPI.reload("data-v-654b5c98", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
