...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
	components: { tree: _deviceTree2.default, richform: _form2.default },
	mixins: [],
	data: function data() {
		return {
			urls: urls,
			treeId: 'device_tree_for_form',
			dimensions: [{
				type: "custom",
				name: L("所有设备", "iptalk"),
				expandLevel: 0
			...
			formMeta: {
				...
				footer: {
					visible: true,
					default: false,
					items: [{ name: "submit", text: L("提交", "iptalk"), classs: "primary submit", icon: "checkmark", tips: L("提交", "iptalk"), click: "submit" }]
				},
				fields: [{
					name: "devid",
					type: "text",
	...
	props: {
		...
		targetDevice: { type: Object, default: function _default() {} },
		devices: { type: Object, default: function _default() {
				return [];
			} } },
	computed: {},
	methods: {
		init: function init() {
			this.$set(this.formData[0], "devid", this.targetDevice.DevID || "");
			this.$set(this.formData[0], "devalias", this.targetDevice.Alias || "");
			this.$set(this.formData[0], "x", this.targetDevice.x);
			this.$set(this.formData[0], "y", this.targetDevice.y);
			this.oldDevID = this.formData[0].devid || "";
			this.$set(this.formMeta, "url", urls[this.action + "DevicesByMap"]);
			this.$set(this.formMeta.header, "title", this.action === "add" ? L("新增设备", "iptalk") : this.action === "mod" ? L("修改设备", "iptalk") : L("设备属性", "iptalk"));
			this.$set(this.formMeta.footer, "visible", this.action === "view" ? false : true);
		},
		beforeSubmit: function beforeSubmit(formDataToSubmit) {
			var deviceTypeToSumbmit = this.getDeviceTypeById(formDataToSubmit.devid);
			var formValidError = this.validateFormData();
			if (formValidError) {
				this.raiseFormTip(L(formValidError));
			} else if (this.action === "add" && this.deviceIsExisted(formDataToSubmit.devid)) {
				this.raiseFormTip(L("设备已存在，勿重复新增", "iptalk"));
				return false;
			} else if (this.targetDevice.type !== deviceTypeToSumbmit) {
				if (this.targetDevice.type === "iptalk_host") {
					this.raiseFormTip(L("设备类型不匹配，请选择主机设备(以2开头8位数)", "iptalk"));
				} else if (this.targetDevice.type === "iptalk_terminal") {
					this.raiseFormTip(L("设备类型不匹配，请选择终端设备(以1开头8位数)", "iptalk"));
				} else if (this.targetDevice.type === "iptalk_speaker") {
					this.raiseFormTip(L("设备类型不匹配，请选择音柱设备", "iptalk"));
				} else if (this.targetDevice.type === "gk680_alarm") {
					this.raiseFormTip(L("设备类型不匹配，请选择汇防报警设备", "iptalk"));
				}
				return false;
			} else {
				return true;
		...
		validateFormData: function validateFormData() {
			if (!this.formData[0].devid) {
				return L("设备ID不能为空", "iptalk");
			}
			if (!this.formData[0].devalias) {
				return L("设备名称不能为空", "iptalk");
			}
			if (!this.formData[0].x || !this.formData[0].y) {
				return L("设备经纬度不能为空", "iptalk");
			}
			return "";
		},
		deviceIsExisted: function deviceIsExisted(id) {
			var device = this.selectDeviceById(id);
			return device ? device.x || device.y : false;
		},
		getDeviceTypeById: function getDeviceTypeById(id) {
			if (id.startsWith("1") && id.length === 8) {
				return "iptalk_terminal";
			} else if (id.startsWith("2") && id.length === 8) {
				return "iptalk_host";
			} else if (id.startsWith("4") && id.length === 8) {
				return "gk680_alarm";
			} else {
		...
		onFormSubmitSuccess: function onFormSubmitSuccess(response) {
			this.raiseFormTip(this.action === "add" ? L("新增成功", "iptalk") : this.action === "mod" ? L("修改成功", "iptalk") : "");
			_eventbus2.default.$emit((this.action === "add" ? "new" : this.action) + "ItemsSuccess", this.formatSuccessResult(response.data.result));
			this.refreshTree();
		},
		formatSuccessResult: function formatSuccessResult(result) {
			var formated = result;
			formated.status = result.DevStatus || this.targetDevice.status;
			return formated;
		},
		onFormSubmitError: function onFormSubmitError(response) {
			this.raiseFormTip(this.action === "add" ? L("新增失败", "iptalk") : this.action === "mod" ? L("修改失败", "iptalk") : "");
			_eventbus2.default.$emit((this.action === "add" ? "new" : this.action) + "ItemsError", response.data.error);
		},
		onTreeItemClick: function onTreeItemClick(event, treeId, treeNode) {
			this.$set(this.formData[0], "devid", treeNode.targetId);
			this.$set(this.formData[0], "devalias", treeNode.Alias);
		},
		raiseFormTip: function raiseFormTip(tip) {
			this.formTip = tip;
			this.showFormTip = true;
			var self = this;
			setTimeout(function () {
				self.showFormTip = false;
			}, 2000);
		},
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/components/richmap/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
		...
		return {
			formMeta: {
				...
				footer: {
					visible: true,
					default: false,
					items: [{ name: "submit", text: L("确定"), classs: "primary", icon: "checkmark", tips: L("确定"), click: function click() {
							this.$parent.$parent.onSubmit();
						} }, { name: "cancel", text: L("取消"), classs: "primary", icon: "refresh", tips: L("取消"), click: function click() {
							this.$parent.$parent.onCancel();
						} }, { name: "default", text: L("恢复默认"), classs: "primary", icon: "refresh", tips: L("恢复默认"), click: function click() {
							this.$parent.$parent.onDefault();
						} }]
				},
				fields: []
			},
	...
	props: {
		formFields: { type: Array, default: function _default() {
				return [];
			} },
		formFieldsData: { type: Object, default: function _default() {} }
	},
	computed: {},
	methods: {
		init: function init() {
			var formatedFormFields = this.formatFormFields(this.formFields);
			this.formMeta.fields = this.formMeta.fields.concat(formatedFormFields);
			(0, _deepAssign2.default)(this.formData[0], this.formFieldsData);
		},
		formatFormFields: function formatFormFields(fields) {
			var formatedFields = fields.map(this.formatFormField);
			return formatedFields;
		},
		formatFormField: function formatFormField(field) {
			var fieldCopy = (0, _deepAssign2.default)({}, field);
			fieldCopy.label = fieldCopy.label || fieldCopy.text;
			var formatedField = (0, _deepAssign2.default)({}, fieldCopy, this.fieldBase);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5e574579\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/components/richmap/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.map-form[data-v-5e574579] {\n\t    border-radius: 5px 0 0 5px;\n}\n.map-form .fade-enter-active[data-v-5e574579], .map-form .fade-leave-active[data-v-5e574579] {\n        transition: opacity 1s\n}\n.map-form .fade-enter[data-v-5e574579], .map-form .fade-leave-active[data-v-5e574579] {\n        opacity: 0\n}\n.map-form .showTip[data-v-5e574579] {\n        position: fixed;\n        top: 50%;\n        left: 50%;\n        color: white;\n        background: rgba(0,0,0,0.5);\n        border-radius: 4px;\n        padding: 1em;\n        cursor: pointer;\n}    \n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-99b036f4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.map-form[data-v-99b036f4],\n\t.map-form .left-panel[data-v-99b036f4],\n\t.map-form .left-panel .tree[data-v-99b036f4],\n\t.map-form .right-panel[data-v-99b036f4] {\n\t\tposition: relative;\n}\n.map-form[data-v-99b036f4],\n\t.map-form .left-panel[data-v-99b036f4] {\n\t\theight: calc(100% - 1px);  /* 为了不挡住底边 1px 的 border */\n}\n.map-form .left-panel .tree[data-v-99b036f4],\n\t.map-form .right-panel[data-v-99b036f4] {\n\t\theight: 100%;\n}\n.map-form[data-v-99b036f4] {\n\t    border-radius: 5px 0 0 5px;\n}\n.map-form .left-panel[data-v-99b036f4] {\n\t\tfloat: left;\n\t\t/*width: 250px;*/\n\t\toverflow:auto;\n\t    border-radius: 5px;\n}\n.map-form .left-panel .tree[data-v-99b036f4],\n\t.map-form .right-panel[data-v-99b036f4] {\n\t\tbackground-color: #fff;\n}\n.map-form .right-panel[data-v-99b036f4] {\n\t\t/*width: calc(100% - 250px);*/\n\t\tfloat: left;\n\t\t/*border-left: 1px solid #d9d9d9;\n\t\tborder-bottom: 1px solid #d9d9d9;*/\n\t\tborder-radius: 0 5px 5px 0;\n}\n.map-form .fade-enter-active[data-v-99b036f4], .map-form .fade-leave-active[data-v-99b036f4] {\n        transition: opacity 1s\n}\n.map-form .fade-enter[data-v-99b036f4], .map-form .fade-leave-active[data-v-99b036f4] {\n        opacity: 0\n}\n.map-form .showTip[data-v-99b036f4] {\n        position: fixed;\n        top: 50%;\n        left: 50%;\n        color: white;\n        background: rgba(0,0,0,0.5);\n        border-radius: 4px;\n        padding: 1em;\n        cursor: pointer;\n}    \n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-5e574579\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/components/richmap/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "map-form"
  }, [_c('richform', {
    attrs: {
      "meta": _vm.formMeta,
      "form-data": _vm.formData
  ...
  }, [(_vm.showFormTip) ? _c('span', {
    staticClass: "showTip"
  }, [_vm._v(_vm._s(_vm.formTip))]) : _vm._e()])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5e574579", module.exports)
  }
}
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-99b036f4\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: ({
      width: _vm.action === 'add' ? '250px' : '0px'
    })
  }, [_c('div', {
    staticClass: "tree"
  }, [_c('tree', {
    ...
    style: ({
      width: _vm.action === 'add' ? 'calc(100% - 250px)' : '100%'
    })
  }, [_c('richform', {
    attrs: {
      "meta": _vm.formMeta,
      ...
      "ajaxOptions": {
        olddevid: _vm.oldDevID
      }
    },
    on: {
      "formSubmitSuccess": _vm.onFormSubmitSuccess,
      "formSubmitError": _vm.onFormSubmitError,
      "formSubmitFailed": _vm.onFormSubmitError
    }
  }), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "fade"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-99b036f4", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5e574579\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/components/richmap/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("0eca81ad", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5e574579\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./map.form.async.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5e574579\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./map.form.async.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-99b036f4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-99b036f4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/map.form.async.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("febafa12", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-99b036f4\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./map.form.async.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-99b036f4\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../utils/lang-loader.js!./map.form.async.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/apps/iptalk/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/map.form.async.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-99b036f4\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/map.form.async.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-99b036f4",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\apps\\iptalk\\map.form.async.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] map.form.async.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-99b036f4", Component.options)
  } else {
    hotAPI.reload("data-v-99b036f4", Component.options)
  }
...
/***/ "./src/components/richmap/map.form.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/components/richmap/map.form.async.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-5e574579\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/components/richmap/map.form.async.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-5e574579",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\components\\richmap\\map.form.async.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] map.form.async.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5e574579", Component.options)
  } else {
    hotAPI.reload("data-v-5e574579", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
