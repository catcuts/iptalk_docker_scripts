...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/broadcastplansource.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
	components: { richform: _form2.default, menubar: _menubar2.default },
	data: function data() {
		return {
			musicLibrary: [],
			onMp3Selected: true,
			librarySelectedMp3IdList: [],
			playlistSelectedMp3Idlist: []
		};
	},

	props: {
		playlist: { type: Array, default: function _default() {
				return [];
			} }
	},
	watch: {},
	...
	methods: {
		...
		onMicRadioSelected: function onMicRadioSelected() {
			...
			this.librarySelectedMp3IdList = [];
			this.playlistSelectedMp3Idlist = [];
		},
		domUpdatedCallback: function domUpdatedCallback(event) {
			var self = this;

			$('.ui.librarymp3item.checkbox').checkbox({
				onChecked: function onChecked() {
					var mp3id = $(this).attr('id');
					self.librarySelectedMp3IdList.push(mp3id);
				},
				onUnchecked: function onUnchecked() {
					var mp3id = $(this).attr('id');
					self.librarySelectedMp3IdList.splice($.inArray(mp3id, self.librarySelectedMp3IdList), 1);
				}
			});
			$('.ui.playlistmp3item.checkbox').checkbox({
				onChecked: function onChecked() {
					var mp3id = $(this).attr('id');
					self.playlistSelectedMp3Idlist.push(mp3id);
				},
				onUnchecked: function onUnchecked() {
					var mp3id = $(this).attr('id');
					self.playlistSelectedMp3Idlist.splice($.inArray(mp3id, self.playlistSelectedMp3Idlist), 1);
				}
			});

			$('.ui.libraryselectall.checkbox').checkbox({
				onChecked: function onChecked() {
					var $childCheckbox = $(this).parents('.libraryselectall').siblings('.mp3ItemList').find('.checkbox');
			...
			$('.ui.playlistselectall.checkbox').checkbox({
				onChecked: function onChecked() {
					var $childCheckbox = $(this).parents('.playlistselectall').siblings('.mp3ItemList').find('.checkbox');
					$childCheckbox.checkbox('check');
				},
				onUnchecked: function onUnchecked() {
					var $childCheckbox = $(this).parents('.playlistselectall').siblings('.mp3ItemList').find('.checkbox');
		...
		selectmp3: function selectmp3() {
			var self = this;
			if (self.librarySelectedMp3IdList.length === 0) {
				toast('请选择曲目！', 1000);
				return;
			}
			this.librarySelectedMp3IdList.forEach(function (item) {
				var _iteratorNormalCompletion = true;
				var _didIteratorError = false;
				var _iteratorError = undefined;

				try {
					for (var _iterator = self.playlist[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						var opt = _step.value;
				...
				try {
					for (var _iterator2 = self.musicLibrary[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
						var _opt = _step2.value;

						if (_opt.id === item) {
							self.playlist.push(_opt);
							break;
						}
					}
				} catch (err) {
		...
		removemp3: function removemp3() {
			var self = this;
			if (self.playlistSelectedMp3Idlist.length === 0) {
				toast('请选择曲目！', 1000);
				return;
			}
			self.playlistSelectedMp3Idlist.forEach(function (item, index) {
				var _iteratorNormalCompletion3 = true;
				var _didIteratorError3 = false;
				var _iteratorError3 = undefined;

				try {
					for (var _iterator3 = self.playlist[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
						var opt = _step3.value;

						if (opt.id === item) {
							self.playlist.splice($.inArray(opt, self.playlist), 1);
							break;
						}
					}
				} catch (err) {
			...
			self.playlistSelectedMp3Idlist = [];
			$(self.$el).find('.playlistmp3item.checked').checkbox('uncheck');
		}
	},
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78bcd73a\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/broadcastplansource.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.broadcastsource[data-v-78bcd73a]{\r\n\theight: 100%;\n}\n.playlistcontent[data-v-78bcd73a]{\r\n\theight: calc(100% - 19px);\n}\n.mp3ItemList[data-v-78bcd73a]{\r\n\tborder: 1px solid rgba(34,36,38,.15);\r\n\theight: calc(100% - 49px);\r\n\tpadding: 10px;\r\n\toverflow:auto;\n}\r\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-78bcd73a\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/broadcastplansource.async.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "broadcastsource"
  }, [_c('div', {
    staticClass: "ui form"
  }, [_c('div', {
  ...
  }, _vm._l((_vm.playlist), function(opt) {
    return _c('div', {
      staticClass: "item"
    }, [_c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-78bcd73a", module.exports)
  }
}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78bcd73a\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/broadcastplansource.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("25614c86", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78bcd73a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./broadcastplansource.async.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78bcd73a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./broadcastplansource.async.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/apps/meeyihis/components/broadcastplansource.async.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/broadcastplansource.async.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-78bcd73a\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/meeyihis/components/broadcastplansource.async.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-78bcd73a",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\apps\\meeyihis\\components\\broadcastplansource.async.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] broadcastplansource.async.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-78bcd73a", Component.options)
  } else {
    hotAPI.reload("data-v-78bcd73a", Component.options)
  }
