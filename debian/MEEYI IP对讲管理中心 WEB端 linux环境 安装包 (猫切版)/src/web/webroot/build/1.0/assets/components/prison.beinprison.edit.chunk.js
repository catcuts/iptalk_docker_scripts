...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.edit.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
		...
		return {
			...
			formMeta: {
				...
				fields: [{
					...
					default: "",
					placeholder: "",
					url: "/mock" + "/v1/webfrontend/prisoners/?_csrf={{ ctx.csrf | safe }}&portrait=true&number=" + this.item[0].row.number,
					...
					type: "text",
					label: L("亲属电话"),
					validation: ['minLength[7]', 'maxLength[20]', 'empty', 'regExp[/^[0-9][0-9][0-9][0-9-*#]{0,16}[0-9]$/]'],
					labelWidth: "70%",
					width: 6,
					showLabel: true,
					default: "",
	...
	computed: {
		areadata: function areadata() {
			return this.item[0].row.area;
		},

		roomdata: function roomdata() {
			return this.item[0].row.room;
		},

		beddata: function beddata() {
			return this.item[0].row.bed;
		},
	...
	watch: {
		areadata: function areadata(newValue, oldValue) {
			...
			_vue2.default.set(this.item[0].row, "room", "null");
			if (newValue == "null") {
				this.formMeta.fields[3][1].attrs.items.length = 0;
				this.formMeta.fields[3][1].attrs.items.push({
					content: "清空",
					value: "null",
					icon: "edit"
				});
			} else {
				var _formMeta$fields$3$1$;

				this.formMeta.fields[3][1].attrs.items.length = 0;
				(_formMeta$fields$3$1$ = this.formMeta.fields[3][1].attrs.items).push.apply(_formMeta$fields$3$1$, [{
					content: "清空",
					value: "null",
					icon: "edit"
		...
		roomdata: function roomdata(newValue, oldValue) {
			...
			_vue2.default.set(this.item[0].row, "bed", "null");
			self.formMeta.fields[3][2].attrs.items = [];
			this.item[1].dispatch('getRoomEmptyBedTable', newValue).then(function (response) {
				var _self$formMeta$fields2;
				...
				if (newValue == self.roomonload) {
					var _self$formMeta$fields;

					(_self$formMeta$fields = self.formMeta.fields[3][2].attrs.items).push.apply(_self$formMeta$fields, [{
						content: "清空",
						value: "null",
						icon: "edit"
					}].concat(_toConsumableArray(self.beddataonload)));
				}
				(_self$formMeta$fields2 = self.formMeta.fields[3][2].attrs.items).push.apply(_self$formMeta$fields2, bed);
			}).catch(function () {
				self.formMeta.fields[3][2].attrs.items.length = 0;
				self.formMeta.fields[3][2].attrs.items.push({
					content: "清空",
					value: "null",
					icon: "edit"
				});
		...
		beddata: function beddata(newValue, oldValue) {
			var self = this;
			self.emitbedname(newValue);
		}
	},
	methods: {
		...
		valid: function valid() {
			if (this.validstatus.validstatus == true) {
				return true;
			} else {
				return false;
			}
		},
		emitbedname: function emitbedname(newValue) {
			var self = this;
			var bedname;
			var beds = self.formMeta.fields[3][2].attrs.items;
			for (var key in beds) {
				if (newValue == beds[key].value) {
					bedname = beds[key].content;
					_eventbus2.default.$emit("prison.beinprison.bedname", bedname);
				}
			}
		}
	},
	created: function created() {
		...
		this.formMeta.fields[1][2].attrs.uploadOpts.data = this.item[0].row.number;

		for (var areakey in this.item[2].children) {
			this.$set(this.rooms, this.item[2].children[areakey].id, []);
			this.formMeta.fields[3][0].attrs.items.push({
				content: this.item[2].children[areakey].label,
				value: this.item[2].children[areakey].id,
				icon: "edit"
			});
			for (var room in this.item[2].children[areakey].children) {
				this.rooms[this.item[2].children[areakey].id].push({
					content: this.item[2].children[areakey].children[room].label,
					value: this.item[2].children[areakey].children[room].id,
					icon: "edit"
				});
			}
		}
		...
		if (this.areadata) {
			var _formMeta$fields$3$1$2;

			this.formMeta.fields[3][1].attrs.items.length = 0;
			(_formMeta$fields$3$1$2 = this.formMeta.fields[3][1].attrs.items).push.apply(_formMeta$fields$3$1$2, [{
				content: "清空",
				value: "null",
				icon: "edit"
			}].concat(_toConsumableArray(this.rooms[this.areadata])));
		}

		if (this.item[0].row.bed) {
			this.roomonload = this.item[0].row.room;
			this.beddataonload = { content: this.item[3].bed_name, value: this.item[3].bed_number, icon: "edit" };
			self.formMeta.fields[3][2].attrs.items.push({ content: this.item[3].bed_name, value: this.item[3].bed_number, icon: "edit" });
		}

		if (this.item[0].row.room) {
			var self = this;
			this.item[1].dispatch('getRoomEmptyBedTable', this.item[0].row.room).then(function (response) {
				var _self$formMeta$fields3;
				...
				(_self$formMeta$fields3 = self.formMeta.fields[3][2].attrs.items).push.apply(_self$formMeta$fields3, bed);
			});
		}

		this.formMeta.fields[1][1][2][0].attrs.items = this.province;
	},
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a70be24a\",\"scoped\":false,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=1!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.edit.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a70be24a\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.edit.vue":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-a70be24a\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.edit.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "beinprisonedit"
  }, [_c('richform', {
    ref: "appform",
    attrs: {
      "meta": _vm.formMeta,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-a70be24a", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("da2a041c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a70be24a\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!../../../../utils/lang-loader.js!./prison.beinprison.edit.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a70be24a\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!../../../../utils/lang-loader.js!./prison.beinprison.edit.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("5cd6e738", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a70be24a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./prison.beinprison.edit.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-a70be24a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./prison.beinprison.edit.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/devices/operates/prison/prison.beinprison.edit.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.edit.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-a70be24a\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/devices/operates/prison/prison.beinprison.edit.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-a70be24a",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\devices\\operates\\prison\\prison.beinprison.edit.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] prison.beinprison.edit.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a70be24a", Component.options)
  } else {
    hotAPI.reload("data-v-a70be24a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
