...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userManager.vue":
...
var _userSetting = __webpack_require__("./src/apps/iptalk/manager/userSetting.vue");

var _userSetting2 = _interopRequireDefault(_userSetting);
...
exports.default = {
	components: { vuetable: _table2.default, usersetting: _userSetting2.default },
	data: function data() {
		return {
			title: L("用户列表", "iptalk"),
			addUser: L("新增用户", "iptalk"),
			cols: [{ name: 'Username', title: L("账号", "iptalk"), width: "100px" }, { name: 'Name', title: L("昵称", "iptalk"), width: "100px" }, { name: 'RegisterTime', title: L("注册时间", "iptalk"), width: "100px", type: "custom", output: function output(row, colname) {
					return new Date(row[colname.name] * 1000).toLocaleString();
				}
			}, { name: 'LastLoginTime', title: L("最后登录时间", "iptalk"), width: "100px", type: "custom", output: function output(row, colname) {
					if (row[colname.name]) {
						return new Date(row[colname.name] * 1000).toLocaleString();
					}
				}
			}, { name: 'IdentityName', title: L("身份", "iptalk"), width: "100px" }],
			rows: [],
			row: null,
			pagination: {
				pageNumber: 0,
	...
	methods: {
		onLoadData: function onLoadData(context) {
			...
			this.getUsers(newPage, this.pagination.pageSize, function (result) {
		...
		getUsers: function getUsers(newPage, pageSize, callback) {
			_webservice2.default.getJSON(urls.getUserList, { newPage: newPage, pageSize: pageSize }).then(function (response) {
		...
		getIdentitys: function getIdentitys() {
			var self = this;
			_webservice2.default.getJSON(urls.getIdentitys).then(function (response) {
				if (response.status == "success") {
					self.identitys = response.result;
				}
			});
		},
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userSetting.vue":
/***/ (function(module, exports, __webpack_require__) {
...
exports.default = {
	...
	data: function data() {
		return {
			Username: L("账号", "iptalk"),
			Password: L("密码", "iptalk"),
			Name: L("昵称", "iptalk"),
			Identity: L("身份", "iptalk"),
			addUser: L("添加用户", "iptalk"),
			editUser: L("编辑用户", "iptalk"),
			deleteUser: L("删除用户", "iptalk")
		};
	},

	props: {
		item: { type: Object },
		identitys: { type: Array },
		isAdd: { type: Boolean }
	},
	methods: {
		add: function add() {
			var self = this;
			_webservice2.default.getJSON(urls.addUser, this.item, function (response) {
				if (response.status == "success") {
					self.$emit("refresh");
		...
		edit: function edit() {
			var self = this;
			_webservice2.default.getJSON(urls.editUser, this.item, function (response) {
				if (response.status == "success") {
					self.$emit("refresh");
					alert(response.result);
				}
		...
		del: function del() {
			var self = this;
			_webservice2.default.getJSON(urls.deleteUserbyID, { "id": this.item.id }, function (response) {
				if (response.status == "success") {
					self.$emit("refresh");
					alert(response.result);
				}
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-657120e4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userManager.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.usermanager[data-v-657120e4]{\r\n\tposition: relative;\r\n\theight: 100%;\r\n\tpadding: 20px;\r\n\toverflow-y:auto;\r\n\toverflow-x:hidden;\n}\n.usermanager h2[data-v-657120e4]{\r\n\ttext-align: center;\n}\n.usermanager .top[data-v-657120e4]{\r\n\tposition: relative;\r\n\theight: 50px;\n}\n.usermanager .center[data-v-657120e4]{\r\n\tposition: relative;\r\n\theight: 450px;\r\n\toverflow-y:auto;\r\n\toverflow-x:hidden;\n}\n.usermanager .down[data-v-657120e4]{\r\n\tposition: relative;\r\n\theight: 30%;\r\n\theight:-moz-calc(100% - 584px);\r\n\theight:-webkit-calc(100% - 584px);\r\n\theight: calc(100% - 584px);\n}\r\n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b1369e\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userSetting.vue":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.setting[data-v-78b1369e]{\r\n\tposition: relative;\r\n\tpadding: 20px 10px;\n}\n.setting label[data-v-78b1369e]{\r\n\twhite-space:nowrap;\r\n\tmin-width: 5em;\r\n\ttext-align:center;\n}\n.setting .right[data-v-78b1369e]{\r\n\tposition: relative;\r\n\ttext-align:right;\n}\r\n", ""]);
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-657120e4\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userManager.vue":
/***/ (function(module, exports, __webpack_require__) {

module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "usermanager"
  }, [_c('div', {
    staticClass: "top"
  }, [_c('button', {
  ...
  }, [_vm._v(_vm._s(_vm.addUser))])]), _vm._v(" "), _c('div', {
    staticClass: "center"
  }, [_c('vuetable', {
    ref: "vuetable",
    attrs: {
    ...
    staticClass: "down"
  }, [(_vm.row != null) ? _c('usersetting', {
    attrs: {
      "item": _vm.row,
      "identitys": _vm.identitys,
      "is-add": _vm.isAdd
    },
    on: {
      "refresh": _vm.refresh
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-657120e4", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-78b1369e\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userSetting.vue":
/***/ (function(module, exports, __webpack_require__) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('label', [_vm._v(_vm._s(_vm.Username))]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    on: {
      "input": function($event) {
        ...
        _vm.item.Username = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "four wide field"
  }, [_c('label', [_vm._v(_vm._s(_vm.Password))]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.item.Password = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "four wide field"
  }, [_c('label', [_vm._v(_vm._s(_vm.Name))]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.item.Name),
    ...
    staticClass: "four wide field"
  }, [_c('label', [_vm._v(_vm._s(_vm.Identity))]), _vm._v(" "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.item.Identity),
    ...
    on: {
      "change": function($event) {
        ...
        _vm.item.Identity = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, _vm._l((_vm.identitys), function(id) {
    return _c('option', {
      domProps: {
        "value": id.ID
      }
  ...
  }, [_vm._v(_vm._s(_vm.addUser))]) : [_c('button', {
    staticClass: "ui button blue right",
    on: {
      "click": _vm.edit
    }
  }, [_vm._v(_vm._s(_vm.editUser))]), _vm._v(" "), _c('button', {
    staticClass: "ui button blue right",
    on: {
      "click": _vm.del
    }
  }, [_vm._v(_vm._s(_vm.deleteUser))])]], 2)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-78b1369e", module.exports)
  }
}

/***/ }),

/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-657120e4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userManager.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-657120e4\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userManager.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("19a63618", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-657120e4\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./userManager.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-657120e4\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./userManager.vue");
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b1369e\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userSetting.vue":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b1369e\",\"scoped\":true,\"hasInlineConfig\":false}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userSetting.vue");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("7d2d6d38", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b1369e\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./userSetting.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-78b1369e\",\"scoped\":true,\"hasInlineConfig\":false}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!../../../../utils/lang-loader.js!./userSetting.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/***/ "./src/apps/iptalk/manager/userManager.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userManager.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-657120e4\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userManager.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-657120e4",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\apps\\iptalk\\manager\\userManager.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] userManager.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-657120e4", Component.options)
  } else {
    hotAPI.reload("data-v-657120e4", Component.options)
  }
...
/***/ "./src/apps/iptalk/manager/userSetting.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")(
  /* script */
  __webpack_require__("./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userSetting.vue"),
  /* template */
  __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-78b1369e\",\"hasScoped\":true}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./utils/lang-loader.js!./src/apps/iptalk/manager/userSetting.vue"),
  /* styles */
  injectStyle,
  /* scopeId */
  "data-v-78b1369e",
...
Component.options.__file = "D:\\project\\webfrontend\\stwebfrontend\\src\\apps\\iptalk\\manager\\userSetting.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-78b1369e", Component.options)
  } else {
    hotAPI.reload("data-v-78b1369e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
