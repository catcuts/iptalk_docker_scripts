...
class systemUpdate(object):
    ...
    def __init__(self,src,dist):
        ...
        self.bkup = dist + "_bkup" # 备份目录
        self.log = dist + "_updating-log" # 日志目录
        self.status = "idle"
        self.errors = []
...
if __name__ == "__main__":
    ...
    if updateEnable:
        systemUpdater = systemUpdate(src,dist) # 实例化
        systemUpdater.un_zip() # 解压
        systemUpdater.update() # 更新
        # systemUpdater.recover() # 还原
